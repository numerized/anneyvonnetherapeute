...
export default function SimpleFooter() {
  ...
  const newsletter = {
    ...
    description:
      "Inscrivez-vous et recevez gratuitement : Des infos sur nos prochains LIVE, 1 code promo - 10 % (COEUR180), le questionnaire de l'amoureux, et un accès à nos capsules audio exclusives pour enrichir votre développement relationnel.",
