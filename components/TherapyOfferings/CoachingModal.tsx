...
export const CoachingModal: React.FC<CoachingModalProps> = ({
  ...
  if (!isOpen || !coaching) {
    console.log(
      'CoachingModal not rendering - isOpen:',
      isOpen,
      'coaching found:',
      !!coaching,
    )
  ...
  const renderPromises = () => {
    if (
      !coaching.mainOffering.promises ||
      coaching.mainOffering.promises.length === 0
    )
      return null
                                ...
                                <ul className="space-y-1 ml-4">
                                  {section.bulletPoints.map(
                                    (point, bulletIdx) => (
                                      ...
                                      >
                                        <span className="text-primary-coral mr-2">
                                          •
                                        </span>
                              ...
                              {option.pricing.individual && (
                                <div>
                                  ...
                                  <p className="text-primary-cream">
                                    ...
                                    {option.pricing.individual.duration}
                                  </p>
                                </div>
                              )}
                              {option.pricing.couple && (
                                <div>
                                  ...
                                  <p className="text-primary-cream">
                                    ...
                                    {option.pricing.couple.duration}
                                  </p>
                                </div>
                              )}
                            </div>
