        ...
        <div className="max-w-3xl mx-auto p-8">
          ...
          <div className="space-y-6 text-primary-cream/90">
            <blockquote className="text-xl italic border-l-4 border-primary-coral pl-4 mb-8">
              "Thérapie sur-mesure - Offrez-vous un accompagnement unique,
              totalement personnalisé et flexible, selon vos besoins spécifiques
              et à votre rythme."
            </blockquote>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <p>
                  ...
                  Explorez tous les thèmes souhaités (relationnel, personnel,
                  professionnel, etc.) avec AYR.
                </p>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-primary-coral mt-1.5">•</span>
                <p>
                  ...
                  Faites le point sur votre situation individuelle, conjugale
                  et/ou relationnelle.
                </p>
              </li>
              <li className="flex items-start gap-3">
                ...
                <p>
                  ...
                  Choisissez le moment qui vous convient, sans contrainte de
                  planning.
                </p>
              </li>
              <li className="flex items-start gap-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <p>
                  ...
                  Accès privilégié pour planifier vos séances selon vos
                  urgences.
                </p>
              </li>
              <li className="flex items-start gap-3">
                ...
                <p>
                  ...
                  Un suivi dédié entre les séances pour une progression
                  continue.
                </p>
              </li>
              <li className="flex items-start gap-3">
                ...
                <p>
                  <strong className="text-primary-coral">
                    Outils et ressources sur-mesure :
                  </strong>{' '}
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <p className="text-lg mb-6">
                  &quot;Vivez une expérience transformative unique lors
                  d&apos;une immersion thérapeutique à Ibiza. Dans ce cadre
                  enchanteur, nous explorerons ensemble vos schémas relationnels
                  et émotionnels pour vous permettre de vous reconnecter
              ...
              <div className="flex items-start gap-4">
                ...
                <p className="text-primary-cream/90 text-lg">
                  Check gratuit à 3 mois pour faire le point
                </p>
              </div>
              <div className="flex items-start gap-4">
                <div className="bg-primary-coral rounded-full w-8 h-8 flex items-center justify-center flex-shrink-0 text-primary-cream">
                ...
                <p className="text-primary-cream/90 text-lg">
                  Report et annulation flexibles
                </p>
              </div>
            </div>
          </div>
