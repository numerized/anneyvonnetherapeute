        ...
        <div className="max-w-3xl mx-auto p-8">
          ...
          <div className="space-y-6 text-primary-cream/90">
            <p className="text-xl mb-6">
              Si vous êtes ici, c&apos;est probablement parce que vous cherchez
              à :
            </p>
              ...
              <li className="flex items-start gap-3">
                ...
                <p>
                  <strong className="text-primary-coral">
                    Changer vos schémas relationnels :
                  </strong>{' '}
                  Comprendre en profondeur les mécanismes qui influencent vos
                  relations amoureuses et personnelles.
                </p>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-primary-coral mt-1.5">•</span>
                <p>
                  <strong className="text-primary-coral">
                    Apaiser vos conflits intérieurs :
                  </strong>{' '}
                  Identifier et transformer les blocages qui freinent votre
                  épanouissement personnel et amoureux.
                </p>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-primary-coral mt-1.5">•</span>
                <p>
                  <strong className="text-primary-coral">
                    Créer une relation plus consciente et épanouissante :
                  </strong>{' '}
                  Passer d&apos;une dynamique conflictuelle ou insatisfaisante à
                  une relation harmonieuse et alignée sur vos aspirations.
                </p>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-primary-coral mt-1.5">•</span>
                <p>
                  <strong className="text-primary-coral">
                    Reprendre le pouvoir sur votre vie amoureuse :
                  </strong>{' '}
                  Devenir un acteur conscient de vos choix amoureux en accédant
                  à des outils et ressources exclusifs.
                </p>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-primary-coral mt-1.5">•</span>
                <p>
                  <strong className="text-primary-coral">
                    Vous engager dans une transformation profonde :
                  </strong>{' '}
                  Travailler sur vous-même et/ou votre couple de manière
                  intensive et sur-mesure pour réinventer votre relation dans un
                  cadre ambitieux et bien défini.
                </p>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-4">
                ...
                <p className="text-primary-cream/90 text-lg">
                  Séances alternées couple/individuel
                </p>
              </div>
              <div className="flex items-start gap-4">
                <div className="bg-primary-coral rounded-full w-8 h-8 flex items-center justify-center flex-shrink-0 text-primary-cream">
