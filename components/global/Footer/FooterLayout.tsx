...
export default function Footer(props: FooterProps) {
  ...
  const newsletter = data?.newsletter || {
    ...
    description: "Inscrivez-vous et recevez gratuitement : 2 questionnaires d'évaluation relationnelle, 1 code promo - 10 % (COEUR180), et un accès à nos capsules audio exclusives pour enrichir votre développement relationnel.",
