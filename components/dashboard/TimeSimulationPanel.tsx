...
export function TimeSimulationPanel({
  ...
  return (
    <div
      style={{ backgroundColor: '#047857', backdropFilter: 'none' }}
      className="fixed bottom-4 right-4 z-50 p-4 border border-emerald-800 rounded-lg shadow-lg"
    >
      <div
      ...
      >
        ...
        <div className="text-xs mt-1 text-white border-t pt-2 border-emerald-800">
          ...
          <strong>
            {format(currentSimDate, 'dd MMMM yyyy', { locale: fr })}
          </strong>
        </div>
      </div>
    </div>
