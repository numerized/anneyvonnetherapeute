      ...
      <div className="space-y-12">
        ...
        <div className="space-y-6">
          <p className="text-primary-cream/90">
            Offrez-vous un accompagnement unique, totalement personnalisé et
            flexible, selon vos besoins spécifiques et à votre rythme.
          </p>
        ...
        <div className="space-y-4">
          <h4 className="text-xl text-primary-cream font-light mb-2 text-left">
            TARIFS
          </h4>
          <div className="bg-primary-forest/30 rounded-[24px] p-6">
            <div className="flex justify-start items-center mb-4 gap-4">
              <span>5 SÉANCES</span>
              <span className="text-primary-coral text-2xl font-bold">
                1200 €
              </span>
            </div>
