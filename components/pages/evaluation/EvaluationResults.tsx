...
const socialCategories: ResultCategory[] = [
  {
    ...
    description:
      'Vous pourriez avoir des difficultés à maintenir votre autonomie dans vos relations sociales.',
    advice: [
  ...
  },
  {
    ...
    description:
      "Vous êtes sur le chemin d'un équilibre social, mais des ajustements peuvent être nécessaires.",
    advice: [
  ...
  },
  {
    ...
    description:
      "Tendance marquée à l'isolement ou à une indépendance excessive.",
    advice: [
...
const intimateCategories: ResultCategory[] = [
  {
    ...
    description:
      'Forte dépendance affective ou amoureuse, avec une difficulté à affirmer vos besoins dans la relation.',
    advice: [
  ...
  },
  {
    ...
    description:
      'Vous commencez à naviguer entre autonomie et connexion, mais des points méritent attention.',
    advice: [
  ...
  },
  {
    ...
    description:
      "Tendance marquée à l'indépendance, pouvant limiter l'intimité ou la connexion émotionnelle.",
    advice: [
    ...
    <div className="space-y-8 p-6 bg-white rounded-lg shadow">
      ...
      <div className="space-y-4">
        ...
        <p className="text-lg font-medium text-primary-coral">
          Score moyen : {socialAverage.toFixed(1)} / 10
        </p>
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-semibold text-primary-coral">
          Section Intime et Amoureuse
        </h3>
        <p className="text-lg font-medium text-primary-coral">
          Score moyen : {intimateAverage.toFixed(1)} / 10
        </p>
        <div className="bg-gray-50 p-4 rounded-lg">
          <h4 className="text-lg font-medium text-gray-800">
            {intimateCategory.title}
          </h4>
      ...
      <div className="mt-8 p-6 bg-primary-coral/10 rounded-lg border-2 border-primary-coral/20">
        <h3 className="text-xl font-bold text-primary-coral mb-2">
          🎁 Cadeau de bienvenue
        </h3>
