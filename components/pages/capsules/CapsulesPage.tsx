    ...
    <main className="min-h-screen bg-primary-cream">
      ...
      <div className="relative bg-primary-forest py-20 overflow-hidden">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-primary-cream/80 max-w-2xl">
        ...
        {/* Decorative circles */}
        <div className="absolute -top-24 -right-24 w-64 h-64 rounded-full bg-primary-coral/20 blur-3xl" />
        <div className="absolute -bottom-32 -left-32 w-96 h-96 rounded-full bg-primary-coral/10 blur-3xl" />
      </div>
