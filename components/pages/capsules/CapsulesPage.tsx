...
const capsules: Capsule[] = [
  ...
  },
  {
    ...
    description:
      "Découvrez des techniques de respiration puissantes pour gérer le stress et l'anxiété au quotidien.",
  ...
  },
  {
    ...
    description:
      'Préparez-vous à une nuit paisible avec cette séance relaxante.',
  ...
  },
  {
    ...
    description:
      "Retrouvez votre équilibre et votre stabilité avec cette méditation d'ancrage puissante.",
  ...
  },
  {
    ...
    description:
      'Commencez votre journée avec vitalité grâce à cette pratique dynamique et revigorante. Une séance conçue pour éveiller votre corps et votre esprit, stimuler votre énergie et vous préparer à une journée productive et positive. Inclut des exercices de respiration énergisante et des visualisations motivantes.',
  ...
  },
  {
    ...
    description:
      'Une séance thérapeutique pour relâcher les émotions stagnantes et retrouver la légèreté.',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl ml-auto text-right">
            ...
            <p className="text-xl text-primary-cream/80">
              Découvrez notre collection de méditations guidées et
              d&apos;exercices pratiques pour vous accompagner dans votre
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        >
          {filteredCapsules.map((capsule) => (
            <div
              key={capsule.id}
              className="bg-primary-dark p-8 rounded-[32px] flex flex-col"
            >
              {/* Video Container */}
                ...
                <div className="relative pb-[56.25%]">
                  {isClient && (
                    <>
                      ...
                      {/* Gradient overlay */}
                      <div
                        className={`absolute inset-0 bg-gradient-to-r ${capsule.gradient} rounded-[32px]`}
                      />
                      {/* Frost bubbles */}
