import { b as V } from './sanity-033f6ba9.js'
const C = /_key\s*==\s*['"](.*)['"]/
function G(n) {
  return typeof n == 'string'
    ? C.test(n.trim())
    : typeof n == 'object' && '_key' in n
}
function W(n) {
  if (!Array.isArray(n)) throw new Error('Path is not an array')
  return n.reduce((t, r, i) => {
    const e = typeof r
    if (e === 'number') return `${t}[${r}]`
    if (e === 'string') return `${t}${i === 0 ? '' : '.'}${r}`
    if (G(r) && r._key) return `${t}[_key=="${r._key}"]`
    if (Array.isArray(r)) {
      const [s, o] = r
      return `${t}[${s}:${o}]`
    }
...
function B(n, t) {
  ...
  const i = Object.entries(t.mappings)
...
function k(n, t, r = []) {
  ...
  if (R(n)) {
    if (n._type === 'block' || n._type === 'span') {
      ...
      return (
        n._type === 'block'
          ? (i.children = k(n.children, t, r.concat('children')))
          : n._type === 'span' && (i.text = k(n.text, t, r.concat('text'))),
        i
      )
    }
...
function X(n, t, r) {
  return k(n, (i, e) => {
    ...
    const d = t.documents[o.source.document],
      f = t.paths[o.source.path],
      u = A(p),
      y = A(f).concat(e.slice(u.length))
    return r({ sourcePath: y, sourceDocument: d, resultPath: e, value: i })
  })
}
const S = 'drafts.'
function Q(n) {
...
function Y(n) {
  ...
  const f = r === 'default' ? void 0 : r,
    u = i === 'default' ? void 0 : i,
    y = Q(e),
    $ = Array.isArray(o) ? W(L(o)) : o,
    h = new URLSearchParams({ baseUrl: t, id: y, type: s, path: $ })
  f && h.set('workspace', f),
    u && h.set('tool', u),
    p && h.set('projectId', p),
    d && h.set('dataset', d),
    e.startsWith(S) && h.set('isDraft', '')
  const _ = [t === '/' ? '' : t]
  f && _.push(f)
  const w = [
    'mode=presentation',
...
function Z(n) {
  ...
  return (
    t !== '/' && (t = t.replace(/\/$/, '')),
    typeof n == 'string' ? { baseUrl: t } : { ...n, baseUrl: t }
  )
}
...
function tt(n, t, r) {
  ...
  if (!s) {
    ...
    throw (
      ((d = e == null ? void 0 : e.error) == null ||
        d.call(e, `[@sanity/client]: ${a}`, {
          result: n,
          resultSourceMap: t,
          config: r,
        }),
  ...
  if (!t)
    return (
      (f = e == null ? void 0 : e.error) == null ||
        f.call(
          e,
          '[@sanity/client]: Missing Content Source Map from response body',
          { result: n, resultSourceMap: t, config: r },
        ),
      n
    )
  if (!r.studioUrl) {
    ...
    throw (
      ((u = e == null ? void 0 : e.error) == null ||
        u.call(e, `[@sanity/client]: ${a}`, {
          result: n,
          resultSourceMap: t,
          config: r,
        }),
    ...
    p = X(
      ...
      ({ sourcePath: a, sourceDocument: l, resultPath: b, value: c }) => {
        ...
        const {
          ...
          workspace: O,
          tool: N,
        } = Z(typeof r.studioUrl == 'function' ? r.studioUrl(l) : r.studioUrl)
        if (!j) return c
  ...
  if (e) {
    ...
    if (
      ((a || l) &&
        ((y = (e == null ? void 0 : e.groupCollapsed) || e.log) == null ||
      ...
      o.encoded.length > 0 &&
        ((h = e == null ? void 0 : e.log) == null ||
          h.call(e, '[@sanity/client]: Table of encoded paths'),
        (_ = (e == null ? void 0 : e.table) || e.log) == null || _(o.encoded)),
      o.skipped.length > 0)
    ) {
      const b = new Set()
      for (const { path: c } of o.skipped)
        b.add(c.replace(C, '0').replace(/\[\d+\]/g, '[]'))
      ;(w = e == null ? void 0 : e.log) == null ||
        w.call(e, '[@sanity/client]: List of skipped paths', [...b.values()])
    }
