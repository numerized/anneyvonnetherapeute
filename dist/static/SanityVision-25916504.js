...
var pp = (n, e, t) =>
  e in n
    ? dp(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
    : (n[e] = t)
var _e = (n, e, t) => (pp(n, typeof e != 'symbol' ? e + '' : e, t), t)
import {
  g as xu,
  R as gt,
  r as H,
...
https://fb.me/react-async-component-lifecycle-hooks`,
  ...
  if (
    (typeof n.getDerivedStateFromProps == 'function' &&
      ((e.componentWillMount = Au), (e.componentWillReceiveProps = Mu)),
    typeof e.getSnapshotBeforeUpdate == 'function')
  ) {
...
function xl(n, e, t) {
  return e && fa(n.prototype, e), t && fa(n, t), n
}
function Eu(n, e, t) {
  return (
    e in n
...
function Ps(n) {
  for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2
      ? da(Object(t), !0).forEach(function (i) {
          Eu(n, i, t[i])
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(n, Object.getOwnPropertyDescriptors(t))
        : da(Object(t)).forEach(function (i) {
...
Rr.propTypes = {
  ...
  split: _.oneOf(['vertical', 'horizontal']),
  style: ui,
  eleRef: _.func,
}
Rr.defaultProps = {}
...
Cl.propTypes = {
  ...
  onMouseDown: _.func.isRequired,
  onTouchStart: _.func.isRequired,
  onTouchEnd: _.func.isRequired,
  split: _.oneOf(['vertical', 'horizontal']),
  style: ui,
  resizerClassName: _.string.isRequired,
}
Cl.defaultProps = { resizerClassName: Bu }
function pa(n, e) {
              ...
              if (g) {
                ...
                if (b.getBoundingClientRect) {
                  ...
                  $ < a
                    ...
                    h && h($),
                    this.setState(
                      Eu({ draggedSize: $ }, O ? 'pane1Size' : 'pane2Size', $),
                    )
                }
              }
            }
        ...
        },
        {
          ...
          value: function (r, s) {
            ...
            var a =
              r.size !== void 0
                ? r.size
                : Oa(r.defaultSize, r.minSize, r.maxSize, s.draggedSize)
...
Dn.propTypes = {
  allowResize: _.bool,
  children: _.arrayOf(_.node).isRequired,
  className: _.string,
  primary: _.oneOf(['first', 'second']),
  minSize: _.oneOfType([_.string, _.number]),
  maxSize: _.oneOfType([_.string, _.number]),
  defaultSize: _.oneOfType([_.string, _.number]),
  size: _.oneOfType([_.string, _.number]),
  split: _.oneOf(['vertical', 'horizontal']),
  onDragStarted: _.func,
  onDragFinished: _.func,
  onChange: _.func,
  onResizerClick: _.func,
  onResizerDoubleClick: _.func,
  style: ui,
  resizerStyle: ui,
  paneClassName: _.string,
  pane1ClassName: _.string,
  pane2ClassName: _.string,
  paneStyle: ui,
  pane1Style: ui,
  pane2Style: ui,
  resizerClassName: _.string,
  step: _.number,
}
Dn.defaultProps = {
  allowResize: !0,
...
class pe extends J {
  ...
  decompose(e, t, i, r) {
    let s =
      e <= 0 && t >= this.length
        ? this
        : new pe(ga(this.text, e, t), Math.min(t, this.length) - Math.max(0, e))
    if (r & 1) {
      let o = i.pop(),
  ...
  replace(e, t, i) {
    ...
    ;[e, t] = ji(this, e, t)
    let r = xr(this.text, xr(i.text, ga(this.text, 0, e)), t),
...
`,
  ...
  static split(e, t) {
    ...
    for (let s of e)
      i.push(s),
        (r += s.length + 1),
        i.length == 32 && (t.push(new pe(i, r)), (i = []), (r = -1))
...
`,
  ...
  static from(e, t = e.reduce((i, r) => i + r.length + 1, -1)) {
    ...
    function f() {
      a != 0 &&
        (l.push(u.length == 1 ? u[0] : mt.from(u, h)),
        (h = -1),
        (a = u.length = 0))
    }
    for (let d of e) c(d)
...
function Pe(n, e, t = !0, i = !0) {
  return (t ? Fu : Up)(n, e, i)
}
function Fu(n, e, t) {
  if (e == n.length) return e
  e && zu(n.charCodeAt(e)) && Zu(n.charCodeAt(e - 1)) && e--
  let i = we(n, e)
  for (e += Je(i); e < n.length; ) {
    let r = we(n, e)
    if (i == Sa || r == Sa || (t && Gp(r))) (e += Je(r)), (i = r)
    else if (ma(r)) {
      let s = 0,
        o = e - 2
      for (; o >= 0 && ma(we(n, o)); ) s++, (o -= 2)
      if (s % 2 == 0) break
      e += 2
    } else break
  }
...
function we(n, e) {
  ...
  return zu(i) ? ((t - 55296) << 10) + (i - 56320) + 65536 : t
}
function vl(n) {
  return n <= 65535
...
class be extends xt {
  ...
  apply(e) {
    ...
    return (
      co(this, (t, i, r, s, o) => (e = e.replace(r, r + (i - t), o)), !1), e
    )
  }
  mapDesc(e, t = !1) {
  ...
  filter(e) {
    ...
    e: for (let o = 0, l = 0; ; ) {
      ...
      for (; l < a || (l == a && s.len == 0); ) {
        ...
        Me(t, u, c), c > 0 && Vt(i, t, s.text), s.forward(u), (l += u)
      }
      let h = e[o++]
      for (; l < h; ) {
        if (s.done) break e
        ...
        Me(t, u, -1),
          Me(r, u, s.ins == -1 ? -1 : s.off == 0 ? s.ins : 0),
          s.forward(u),
          (l += u)
      }
    }
    ...
    if (o.ins == -1 && l.ins == -1) {
      ...
      for (Me(r, l.ins, -1); h; ) {
        ...
        o.ins >= 0 &&
          a < o.i &&
          o.len <= u &&
          (Me(r, 0, o.ins), s && Vt(s, r, o.text), (a = o.i)),
          o.forward(u),
          (h -= u)
      }
      l.next()
...
function Wu(n, e, t = !1) {
  ...
  for (let l = !1; ; ) {
    ...
    if (s.ins == 0) Me(i, s.len, 0, l), s.next()
      ...
      Me(i, 0, o.ins, l), r && Vt(r, i, o.text), o.next()
    else {
      if (s.done || o.done) throw new Error('Mismatched change set lengths')
      {
        ...
        if (s.ins == -1) {
          ...
          Me(i, a, u, l), r && u && Vt(r, i, o.text)
        } else
          o.ins == -1
            ? (Me(i, s.off ? 0 : s.len, a, l), r && Vt(r, i, s.textBit(a)))
            : (Me(i, s.off ? 0 : s.len, o.off ? 0 : o.ins, l),
              r && !o.off && Vt(r, i, o.text))
    ...
    return {
      ...
      update(c, f) {
        if (
          ...
          let d = i(c)
          if (l ? !ba(d, c.values[o], r) : !r(d, c.values[o]))
...
class Ae {
  ...
  create(e) {
    let t = e.facet(ya).find((i) => i.field == this)
...
function Kp(n, e, t) {
  ...
  function s(o, l) {
    ...
    } else if (o instanceof Lu) s(o.inner, o.prec)
    else if (o instanceof Ae) i[l].push(o), o.provides && s(o.provides, l)
    else if (o instanceof kr)
      i[l].push(o), o.facet.extensions && s(o.facet.extensions, ci.default)
    else {
      let h = o.extension
      if (!h)
        throw new Error(
...
const qu = T.define(),
  ...
  Iu = T.define({ combine: (n) => (n.length ? n[0] : void 0), static: !0 }),
  Vu = T.define(),
  _u = T.define(),
  Xu = T.define(),
  Yu = T.define({ combine: (n) => (n.length ? n[0] : !1) })
class Dt {
  constructor(e, t) {
...
function mo(n, e, t) {
  ...
  return (
    ...
    {
      changes:
        e.changes instanceof be
          ? e.changes
          : be.of(e.changes || [], t, n.facet(Iu)),
...
function Gu(n, e, t) {
  ...
  for (let s = 1; s < e.length; s++) {
    ...
    i = Nu(i, mo(n, e[s], o ? i.changes.newLength : n.doc.length), o)
  }
  let r = ye.create(
    n,
    i.changes,
...
function nO(n) {
  ...
  for (let r = t.length - 1; r >= 0; r--) {
    let s = t[r](n)
    s && Object.keys(s).length && (i = Nu(i, mo(e, s, n.changes.newLength), !0))
  }
  return i == n
    ? n
    : ye.create(
...
function oO(n) {
  ...
  for (let e = 0; e < n.length; e++) {
    ...
    if (
      /\w/.test(t) ||
      (t > '' && (t.toUpperCase() != t.toLowerCase() || sO.test(t)))
    )
      return !0
  }
  return !1
...
class U {
  ...
  changes(e = []) {
    return e instanceof be
      ? e
      : be.of(e, this.doc.length, this.facet(U.lineSeparator))
  }
  toText(e) {
...
class K {
  ...
  update(e) {
    ...
    if ((i && (t = t.slice().sort(yo)), this.isEmpty))
      return t.length ? K.of(t) : this
    let l = new Hu(this, null, -1).goto(0),
      a = 0,
      h = [],
      u = new Ht()
        ...
        u.addChunk(this.chunkPos[l.chunkIndex], this.chunk[l.chunkIndex])
          ...
          : ((!o || r > l.to || s < l.from || o(l.from, l.to, l.value)) &&
              (u.addInner(l.from, l.to, l.value) ||
                h.push(bo.create(l.from, l.to, l.value))),
            l.next())
  ...
  static compare(e, t, i, r, s = -1) {
    let o = e.filter((c) => c.maxPoint > 0 || (!c.isEmpty && c.maxPoint >= s)),
      ...
      h = new Ji(o, a, s),
      u = new Ji(l, a, s)
    i.iterGaps((c, f, d) => ka(h, c, u, f, d, r)),
      i.empty && i.length == 0 && ka(h, 0, u, 0, 0, r)
  }
  static eq(e, t, i = 0, r) {
    r == null && (r = 1e9 - 1)
  ...
  static of(e, t = !1) {
    let i = new Ht()
    for (let r of e instanceof bo ? [e] : t ? aO(e) : e)
...
class Ht {
  ...
  add(e, t, i) {
    this.addInner(e, t, i) ||
      (this.nextLayer || (this.nextLayer = new Ht())).add(e, t, i)
  }
  addInner(e, t, i) {
  ...
  static from(e, t = null, i = -1) {
    ...
    for (let s = 0; s < e.length; s++)
      for (let o = e[s]; !o.isEmpty; o = o.nextLayer)
        o.maxPoint >= i && r.push(new Hu(o, t, i, s))
...
class Ji {
  ...
  removeActive(e) {
    Kn(this.active, e),
      ...
      (this.minActive = Da(this.active, this.activeTo))
  }
  addActive(e) {
    let t = 0,
...
const Do = 'ͼ',
  Ca = typeof Symbol > 'u' ? '__' + Do : Symbol.for(Do),
  Co =
    typeof Symbol > 'u'
      ? '__styleSet' + Math.floor(Math.random() * 1e8)
      : Symbol('styleSet'),
  va = typeof globalThis < 'u' ? globalThis : typeof window < 'u' ? window : {}
class Kt {
  constructor(e, t) {
    this.rules = []
    let { finish: i } = t || {}
...
`)
  ...
  static newName() {
    let e = va[Ca] || 1
    return (va[Ca] = e + 1), Do + e.toString(36)
  }
  static mount(e, t, i) {
    let r = e[Co],
      s = i && i.nonce
    r ? s && r.setNonce(s) : (r = new hO(e, s)),
...
class gO {
  ...
  setRange(e) {
    ...
    this.set(
      t,
      Math.min(e.anchorOffset, t ? kt(t) : 0),
      i,
      Math.min(e.focusOffset, i ? kt(i) : 0),
    )
  }
  set(e, t, i, r) {
    ;(this.anchorNode = e),
...
let Pa
function yi(n, e, t = e) {
  let i = Pa || (Pa = document.createRange())
...
function oc(n, e, t, i, r, s) {
  ...
  ;(n.length += c), sc(n, h, u, l, a, i, 0, r, s)
}
let je =
    typeof navigator < 'u'
      ? navigator
...
const Qo = /Edge\/(\d+)/.exec(je.userAgent),
  lc = /MSIE \d/.test(je.userAgent),
  Po = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(je.userAgent),
  ds = !!(lc || Po || Qo),
  Ma = !ds && /gecko\/(\d+)/i.test(je.userAgent),
  $s = !ds && /Chrome\/(\d+)/.exec(je.userAgent),
  $a = 'webkitFontSmoothing' in wo.documentElement.style,
  ac = !ds && /Apple Computer/.test(je.vendor),
  Ea = ac && (/Mobile\/\w+/.test(je.userAgent) || je.maxTouchPoints > 2)
var F = {
  mac: Ea || /Mac/.test(je.platform),
  windows: /Win/.test(je.platform),
  linux: /Linux|X11/.test(je.platform),
  ie: ds,
  ie_version: lc ? wo.documentMode || 6 : Po ? +Po[1] : Qo ? +Qo[1] : 0,
  gecko: Ma,
  gecko_version: Ma ? +(/Firefox\/(\d+)/.exec(je.userAgent) || [0, 0])[1] : 0,
  chrome: !!$s,
  ...
  safari: ac,
  webkit_version: $a
    ? +(/\bAppleWebKit\/(\d+)/.exec(je.userAgent) || [0, 0])[1]
    : 0,
  tabSize:
    wo.documentElement.style.tabSize != null ? 'tab-size' : '-moz-tab-size',
}
const bO = 256
class ht extends ne {
  constructor(e) {
...
class Rt extends ne {
  ...
  merge(e, t, i, r, s, o) {
    return i &&
      (!(i instanceof Rt && i.mark.eq(this.mark)) ||
        (e && s <= 0) ||
        (t < this.length && o <= 0))
      ? !1
      : (oc(this, e, t, i ? i.children.slice() : [], s - 1, o - 1),
        this.markDirty(),
        !0)
  }
  split(e) {
...
class _t extends ne {
  ...
  split(e) {
    let t = _t.create(this.widget, this.length - e, this.side)
...
ht.prototype.children = _t.prototype.children = qi.prototype.children = Al
function hc(n, e) {
  let t = n.dom,
    { children: i } = n,
    r = 0
...
function uc(n, e, t) {
  ...
  e instanceof Rt &&
  r.length &&
  (i = r[r.length - 1]) instanceof Rt &&
  i.mark.eq(e.mark)
    ? uc(i, e.children[0], t - 1)
...
Vn.prototype.mapMode = Re.TrackBefore
...
class ge extends ne {
  ...
  merge(e, t, i, r, s, o) {
    ...
    return (
      ...
      oc(this, e, t, i ? i.children.slice() : [], s, o),
      !0
    )
  }
  split(e) {
  ...
  sync(e, t) {
    ...
    if (
      ...
      !this.length ||
      (r.nodeName != 'BR' &&
        ((i = ne.get(r)) === null || i === void 0 ? void 0 : i.isEditable) ==
          !1 &&
...
class bn {
  ...
  getLine() {
    return (
      this.curLine ||
        (this.content.push((this.curLine = new ge())), (this.atCursorPos = !0)),
      this.curLine
    )
  }
  flushBuffer(e = this.bufferMarks) {
    this.pendingBuffer &&
      (this.curLine.append(er(new qi(-1), e), e.length),
      (this.pendingBuffer = 0))
  }
  addBlockWidget(e) {
    ...
    this.pendingBuffer && e <= this.bufferMarks.length
      ...
      !this.posCovered() &&
        !(
          e &&
          this.content.length &&
          this.content[this.content.length - 1] instanceof Et
        ) &&
        this.getLine()
  }
  buildText(e, t, i) {
    for (; e > 0; ) {
      ...
      this.flushBuffer(t.slice(t.length - i)),
        this.getLine().append(
          er(new ht(this.text.slice(this.textOff, this.textOff + r)), t),
          i,
        ),
        (this.atCursorPos = !0),
        (this.textOff += r),
  ...
  point(e, t, i, r, s, o) {
    ...
    if (i instanceof ei)
      if (i.block)
        ...
        let a = _t.create(i.widget || Ii.inline, l, l ? 0 : i.startSide),
          h =
            this.atCursorPos &&
            !a.isEditable &&
            s <= r.length &&
...
function QO(n, e, t, i, r) {
  for (let s = 0; s <= i.length; s++) {
    ...
    for (let h = o, u = a, c = a; h < l; h++) {
      let f = ie[h]
      if (f == 128)
        h < l - 1 && u == ie[h + 1] && u & 24 ? (f = ie[h] = u) : (ie[h] = 256)
      else if (f == 64) {
        let d = h + 1
        for (; d < l && ie[d] == 64; ) d++
...
function Ro(n, e, t, i, r, s, o) {
  ...
  if (i % 2 == r % 2)
    for (let a = e, h = 0; a < t; ) {
      ...
      f ? Ro(n, a, p, i + 1, r, f, o) : a < p && o.push(new Xt(a, p, d)),
        (a = p)
    }
  else
    for (let a = t, h = s.length; a > e; ) {
      ...
      f ? Ro(n, p, a, i + 1, r, f, o) : p < a && o.push(new Xt(p, a, d)),
        (a = p)
    }
}
...
function MO(n, e, t) {
  ...
  if (e == xi && !t.length && !wO.test(n)) return gc(n.length)
...
function $O(n, e, t, i, r) {
  ...
  ;(u < a.from || u > a.to) && (u = h),
    (mc = n.text.slice(Math.min(o, u), Math.max(o, u)))
...
const Sc = T.define(),
  ...
  vc = T.define({ combine: (n) => n.some((e) => e) }),
  wc = T.define()
class Ti {
      ...
      if (this.mustUpdate) {
        ...
        if (((this.mustUpdate = null), this.value.update))
          try {
            ...
            if (
              (qe(t.state, i, 'CodeMirror plugin crashed'), this.value.destroy)
            )
              try {
                this.value.destroy()
              } catch {}
...
class it {
  ...
  static extendWithRanges(e, t) {
    ...
    for (let r = 0, s = 0, o = 0, l = 0; ; r++) {
      ...
      if (!a) return i
      new it(a.fromA, a.toA, a.fromB, a.toB).addToSet(i),
        (o = a.toA),
        (l = a.toB)
    }
  }
...
class Ta extends ne {
  ...
  updateInner(e, t, i) {
    ...
    if (
      ...
      for (let o of this.children)
        o instanceof Et && o.widget instanceof Eo && s.push(o.dom)
    r.updateGaps(s)
  }
  ...
  updateSelection(e = !1, t = !1) {
    ...
    let i = this.view.root.activeElement,
      ...
      s =
        !r &&
        Dr(this.dom, this.view.observer.selectionRange) &&
    ...
    ;(o ||
        ...
        if (c)
          if (l.empty) {
            if (F.gecko) {
              ...
              if (f && f != 3) {
                let d = (f == 1 ? ic : nc)(a.node, a.offset)
      ...
      (this.impreciseAnchor = a.precise
        ? null
        : new $e(u.anchorNode, u.anchorOffset)),
      (this.impreciseHead = h.precise
        ? null
        : new $e(u.focusNode, u.focusOffset))
  }
  ...
  childCursor(e = this.length) {
    ...
    return t && (e -= this.children[--t].length), new rc(this.children, e, t)
  }
  computeBlockGapDeco() {
    let e = [],
  ...
  updateDeco() {
    let e = 1,
      ...
      i = !1,
      r = this.view.state.facet(Ac).map((s, o) => {
...
function Ec(n, e) {
  ...
  let i = ic(t.focusNode, t.focusOffset),
...
function zo(n, e, t) {
  ...
  for (let p = n.firstChild; p; p = p.nextSibling) {
    ...
    for (let g = 0; g < O.length; g++) {
      let S = O[g]
      r && Bs(r, S) && (S = Fa(za(S, r.bottom), r.top))
      let b = qO(e, S),
        D = IO(t, S)
  ...
  for (let l = 0; l < i; l++) {
    ...
    for (let h = 0; h < a.length; h++) {
      ...
      if (u.left - 1 <= e && u.right + 1 >= e && c < s) {
        ...
        if (
          ((F.chrome || F.gecko) &&
            yi(n, l).getBoundingClientRect().left == u.right &&
            (d = !f),
          c <= 0)
        )
...
function Bc(n, e, t, i = -1) {
  ...
  if (d < n.viewport.from)
    return n.viewport.from == 0 ? 0 : t ? null : Wa(n, o, a, u, c)
  if (d > n.viewport.to)
  ...
  if (
    D.isWidget &&
    ((s = D.dom) === null || s === void 0 ? void 0 : s.nodeType) == 1
  ) {
...
function Zo(n, e) {
  ...
  if (Array.isArray(t.type)) {
    for (let i of t.type)
      if (i.to > e || (i.to == e && (i.to == t.to || i.type == Fe.Text)))
        return i
  }
  return t
}
...
class GO {
  constructor(e, t) {
    ;(this.points = e),
      (this.text = ''),
      (this.lineSeparator = t.facet(U.lineSeparator))
  }
  append(e) {
    this.text += e
  }
...
function Rc(n, e) {
  ...
  if (e.bounds) {
    let { from: o, to: l } = e.bounds,
      a = r.from,
      h = null
    ;(s === 8 || (F.android && e.text.length < l - o)) &&
      ((a = r.to), (h = 'end'))
...
function Fl(n, e, t, i = -1) {
  ...
  let o,
    l = () => o || (o = KO(n, e, t))
  return (
    n.state.facet(kc).some((a) => a(n, e.from, e.to, s, l)) || n.dispatch(l()),
    !0
  )
}
function KO(n, e, t) {
    ...
    if (
      ...
      i = r.changeByRange((p) => {
        ...
        return {
          changes: S,
          range: a
            ? w.range(Math.max(0, a.anchor + b), Math.max(0, a.head + b))
            : p.map(S),
        }
      })
...
function eg(n) {
  ...
  return (
    t && (e.push(new La(t, i)), (r != t || s != i) && e.push(new La(r, s))), e
  )
}
function tg(n, e) {
...
ut.mousedown = (n, e) => {
  if ((n.observer.flush(), n.inputState.lastTouchTime > Date.now() - 2e3))
    return !1
  let t = null
  for (let i of n.state.facet(yc)) if (((t = i(n, e)), t)) break
...
let Va = (n, e, t) => e >= t.top && e <= t.bottom && n >= t.left && n <= t.right
function fg(n, e, t, i) {
  let r = ge.find(n.docView, e)
  if (!r) return 1
  ...
  if (o && Va(t, i, o)) return -1
  let l = r.coordsAt(s, 1)
  return l && Va(t, i, l) ? 1 : o && o.bottom >= i ? -1 : 1
}
function _a(n, e) {
...
function pg(n, e) {
  ...
  return {
    ...
    get(s, o, l) {
      let a = _a(n, s),
        h,
        u = Ia(n, a.pos, a.bias, i)
      if (t.pos != a.pos && !o) {
        let c = Ia(n, t.pos, t.bias, i),
  ...
  return (
    ...
    e.dataTransfer &&
      (e.dataTransfer.setData(
        'Text',
        ps(n.state, El, n.state.sliceDoc(t.from, t.to)),
      ),
...
ut.drop = (n, e) => {
  ...
  if (t && t.length) {
    let i = Array(t.length),
      ...
      s = () => {
        ++r == t.length &&
          Ga(n, e, i.filter((o) => o != null).join(n.state.lineBreak), !1)
      }
...
ut.paste = (n, e) => {
  ...
  return t
    ? (Zc(n, t.getData('text/plain') || t.getData('text/uri-list')), !0)
    : (cg(n), !1)
}
function gg(n, e) {
...
ut.beforeinput = (n, e) => {
  ...
  if (e.inputType == 'insertReplacementText' && n.observer.editContext) {
    ...
    if (s && o.length) {
      ...
      return Fl(n, { from: a, to: h, insert: n.state.toText(s) }, null), !0
    }
  }
  let r
  if (
...
class ze {
  ...
  setHeight(e) {
    this.height != e &&
      (Math.abs(this.height - e) > vr && (Vi = !0), (this.height = e))
  }
  replace(e, t, i) {
    return ze.of(i)
  }
  ...
  applyChanges(e, t, i, r) {
    ...
    for (let l = r.length - 1; l >= 0; l--) {
      ...
      ;(u += f.from - a), (a = f.from)
      let p = zl.build(i.setDoc(o), e, u, c)
...
class ve extends ze {
  ...
  replace(e, t, i) {
    ...
    if (r > 0) {
      let s = i[i.length - 1]
      s instanceof ve
        ? (i[i.length - 1] = new ve(s.length + r))
        : i.push(null, new ve(r - 1))
    }
    if (e > 0) {
      let s = i[0]
      s instanceof ve
        ? (i[0] = new ve(e + s.length))
        : i.unshift(new ve(e - 1), null)
    }
    return ze.of(i)
  }
  decomposeLeft(e, t) {
  ...
  updateHeight(e, t = 0, i = !1, r) {
    ...
    if (r && r.from <= t + this.length && r.more) {
      let o = [],
        ...
        a = -1
      for (
        r.from > t && o.push(new ve(r.from - t - 1).updateHeight(e, t));
        l <= s && r.more;
...
class zl {
    ...
    if (this.lineStart > -1) {
      ...
      r instanceof Ne
        ...
        : (i > this.pos || !this.isCovered) &&
          this.nodes.push(new Ne(i - this.pos, -1)),
        (this.writtenTo = i),
        t > i &&
  ...
  point(e, t, i) {
    if (e < t || i.heightRelevant) {
      ...
      let o = t - e
      i.block
        ? this.addBlock(new Ic(o, r, i))
        : (o || s || r >= kg) && this.addLineDeco(r, s, o)
...
class eh {
  ...
  update(e, t = null) {
    ...
    Ka(),
      ...
      (this.heightMap.height != o || Vi) && (e.flags |= 2),
      l
  ...
  measure(e) {
    ...
    if (
      ...
      if (
        ...
        o ||
          (r.lineWrapping && Math.abs(b - this.contentDOMWidth) > r.charWidth))
      ) {
        let {
          lineHeight: k,
          charWidth: y,
        ...
        ;(o = k > 0 && r.refresh(s, k, y, Q, b / y, v)),
          o && ((e.docView.minWidth = 0), (h |= 8))
      }
      O > 0 && g > 0
        ? (u = Math.max(O, g))
        : O < 0 && g < 0 && (u = Math.min(O, g)),
        Ka()
      ...
      a = (u, c, f, d) => {
        ...
        if (!g) {
          if (
            ...
            t &&
            i &&
            t.visibleRanges.some((D) => D.from <= c && D.to >= c)
          ) {
          ...
          if (O > 2e6)
            for (let y of e)
              y.from >= u.from &&
                ...
                y.from * this.heightOracle.charWidth + S <
  ...
  lineBlockAt(e) {
    return (
      ...
      hn(
        this.heightMap.lineAt(e, ae.ByPos, this.heightOracle, 0, 0),
        this.scaler,
      )
    )
  }
...
class Eg {
  ...
  onSelectionChange(e) {
    ...
    if (i.state.facet(Lt) ? i.root.activeElement != this.dom : !Dr(this.dom, r))
      return
  ...
  readMutation(e) {
    ...
    if (
      ...
      let i = ih(t, e.previousSibling || e.target.previousSibling, -1),
        r = ih(t, e.nextSibling || e.target.nextSibling, 1)
      return {
  ...
  update(e) {
    this.editContext &&
      ...
      e.startState.facet(Lt) != e.state.facet(Lt) &&
        (e.view.contentDOM.editContext = e.state.facet(Lt)
  ...
  constructor(e) {
    ...
    ;(this.handlers.textupdate = (i) => {
      let { anchor: r } = e.state.selection.main,
        s = this.toEditorPos(i.updateRangeStart),
        o = this.toEditorPos(i.updateRangeEnd)
...
`),
      ...
      l.from == this.from && r < this.from
        ? (l.from = r)
        : l.to == this.to && r > this.to && (l.to = r),
        !(l.from == l.to && !l.insert.length) &&
      ...
      (this.handlers.textformatupdate = (i) => {
        ...
        e.dispatch({ effects: Qc.of(W.set(r)) })
      }),
  ...
  update(e) {
    ...
    (this.composing.drifted ||
      e.transactions.some(
        (i) =>
          !i.isUserEvent('input.type') &&
          i.changes.touchesRange(this.from, this.to),
      ))
...
class B {
  ...
  constructor(e = {}) {
    ...
    ;(this.dispatchTransactions =
      ...
      (this.viewState = new eh(e.state || U.create(e))),
      e.scrollTo &&
        e.scrollTo.is(tr) &&
  ...
  update(e) {
    ...
    if (
      (r.startState.facet(lr) != r.state.facet(lr) &&
  ...
  measure(e = !0) {
    ...
    try {
      for (let l = 0; ; l++) {
        if (o < 0)
          if (tc(i)) (s = -1), (o = this.viewState.heightMap.height)
          else {
  ...
  get themeClasses() {
    return (
      Lo + ' ' + (this.state.facet(jo) ? _c : Vc) + ' ' + this.state.facet(lr)
    )
  }
  updateAttrs() {
    let e = sh(this, Pc, {
    ...
    this.state.readOnly && (t['aria-readonly'] = 'true'), sh(this, Bl, t)
  ...
  mountStyles() {
    ...
    Kt.mount(
      this.root,
      this.styleModules.concat(Mg).reverse(),
      e ? { nonce: e } : void 0,
    )
  }
  readMeasured() {
  ...
  moveByChar(e, t, i) {
    return Rs(this, e, ja(this, e, t, i))
  }
  moveByGroup(e, t) {
    return Rs(
      this,
      e,
      ja(this, e, t, (i) => YO(this, e.head, i)),
    )
  }
  visualLineSide(e, t) {
  ...
  bidiSpans(e) {
    if (e.length > Tg) return gc(e.length)
    ...
    for (let s of this.bidiCache)
      if (
        s.from == e.from &&
        s.dir == t &&
        (s.fresh || Oc(s.isolates, (i = Ra(this, e))))
      )
        return s.order
    i || (i = Ra(this, e))
    let r = MO(e.text, t, i)
  ...
  focus() {
    this.observer.ignore(() => {
      Ju(this.contentDOM), this.docView.updateSelection()
    })
  }
  setRoot(e) {
    this._root != e &&
...
B.scrollHandler = wc
B.focusChangeEffect = Dc
B.perLineTextDirection = Cc
B.exceptionSink = xc
B.updateListener = Fo
B.editable = Lt
B.mouseSelectionStyle = yc
B.dragMovesSelection = bc
B.clickAddsSelectionRange = Sc
B.decorations = Pn
B.outerDecorations = Ac
B.atomicRanges = Rl
...
const Zg = Di.default(
  ...
  _n = T.define({ enables: Zg }),
  oh = new WeakMap()
function Yc(n) {
  let e = n.facet(_n),
    t = oh.get(e)
  return t || oh.set(e, (t = Lg(e.reduce((i, r) => i.concat(r), [])))), t
}
function Wg(n, e, t) {
...
function Nc(n, e, t, i) {
  ...
  qt &&
    ...
    qt.scope == i &&
    ((l = qt.prefix + ' '),
    Fc.indexOf(e.keyCode) < 0 && ((h = !0), (qt = null)))
  let c = new Set(),
    f = (g) => {
      if (g) {
        for (let S of g.run)
          if (!c.has(S) && (c.add(S), S(t)))
...
function qg(n, e, t) {
  ...
  if (
    (O && (n.lineWrapping || d.widgetLineBreaks) && (O = lh(n, i, 1, O)),
    g && (n.lineWrapping || p.widgetLineBreaks) && (g = lh(n, r, -1, g)),
  ...
  function b({ top: k, bottom: y, horizontal: Q }) {
    let R = []
    for (let M = 0; M < Q.length; M += 2) R.push(S(Q[M], k, Q[M + 1], y))
    return R
  }
  function D(k, y, Q) {
    let R = 1e9,
      ...
      j = []
    function Z($, z, I, L, ee) {
      let re = n.coordsAtPos($, $ == Q.to ? -2 : 2),
        fe = n.coordsAtPos(I, I == Q.from ? 2 : -2)
      !re ||
        !fe ||
        ((R = Math.min(re.top, fe.top, R)),
        (M = Math.max(re.bottom, fe.bottom, M)),
        ee == he.LTR
    ...
    for (let $ of n.visibleRanges)
      if ($.to > A && $.from < x)
        for (let z = Math.max($.from, A), I = Math.min($.to, x); ; ) {
...
const wr = T.define()
function Uc(n) {
  return [Oe.define((e) => new Vg(e, n)), wr.of(n)]
}
const Hc = !F.ios,
  An = T.define({
    combine(n) {
...
function Kc(n = {}) {
  return [An.of(n), _g, Xg, Yg, vc.of(!0)]
}
function Jc(n) {
...
Hc &&
  (Vo['.cm-line'].caretColor = Vo['.cm-content'].caretColor =
    'transparent !important')
const Yg = Di.highest(B.theme(Vo)),
  ef = X.define({
    map(n, e) {
  ...
  Ng = Oe.fromClass(
    class {
      ...
      setDropPos(n) {
        this.view.state.field(un) != n &&
          this.view.dispatch({ effects: ef.of(n) })
      }
    },
    {
      eventObservers: {
...
class Hg {
  ...
  createDeco(e) {
    ...
    for (let { from: r, to: s } of Ug(e, this.maxLength))
      hh(e.state.doc, this.regexp, r, s, (o, l) => this.addMatch(l, e, o, i))
    return t.finish()
  }
  updateDeco(e, t) {
    let i = 1e9,
    ...
    for (let s of e.visibleRanges) {
      ...
      if (l > o) {
        ...
        if (a == h)
          ...
          hh(e.state.doc, this.regexp, u, c, (O, g) =>
            this.addMatch(g, e, O, p),
          )
        t = t.update({
          filterFrom: u,
          filterTo: c,
...
const Qr = T.define({
  combine(n) {
    ...
    return (
      (e.replaceTabs = !em()) &&
        (e.specialChars = new RegExp('	|' + e.specialChars.source, _o)),
      e.addSpecialChars &&
  ...
  let t = n.posAtCoords({ x: e.clientX, y: e.clientY }, !1),
    ...
    s =
      r > Xo
        ...
        : r == i.length
          ? cm(n, e.clientX)
          : Ni(i.text, n.state.tabSize, t - i.from)
    ...
    class {
      ...
      readMeasure() {
        ...
        if (this.position == 'fixed' && this.manager.tooltipViews.length) {
          ...
          if (F.gecko) t = s.offsetParent != this.container.ownerDocument.body
          else if (s.style.top == en && s.style.left == '0px') {
      ...
      writeMeasure(n) {
        ...
        for (let l = 0; l < this.manager.tooltips.length; l++) {
          ...
          let d = a.arrow ? h.dom.querySelector('.cm-tooltip-arrow') : null,
            p = d ? 7 : 0,
            O = f.right - f.left,
            g = (e = fh.get(h)) !== null && e !== void 0 ? e : f.bottom - f.top,
            S = h.offset || bm,
            ...
            D =
              f.width > i.right - i.left
                ...
                : b
                  ? Math.max(
                      i.left,
                      Math.min(c.left - (d ? 14 : 0) + S.x, i.right - O),
                    )
                  : Math.min(
                      Math.max(i.left, c.left - O + (d ? 14 : 0) - S.x),
                      i.right - O,
                    ),
            v = this.above[l]
          !a.strictSide &&
          ...
          if (k < g && h.resize !== !1) {
            ...
            fh.set(h, g), (u.style.height = (g = k) / s + 'px')
          ...
          h.overlap !== !0 &&
            o.push({ left: D, top: y, right: Q, bottom: y + g }),
...
class xm {
  ...
  startHover() {
    ...
    let r,
      s = 1
    if (i instanceof _t) r = i.posAtStart
    else {
...
function Cm(n, e = {}) {
  ...
  return {
    ...
    extension: [
      i,
      Oe.define((r) => new xm(r, n, i, t, e.hoverTime || 300)),
      ym,
    ],
  }
}
    ...
    update(n) {
      ...
      this.top.container != e.topContainer &&
        ...
        this.bottom.container != e.bottomContainer &&
          (this.bottom.sync([]),
          (this.bottom = new ur(n.view, !1, e.bottomContainer))),
  ...
  class {
    constructor(n) {
      ;(this.view = n),
        ...
        (this.gutters = n.state.facet(yn).map((e) => new gh(n, e)))
    ...
    syncGutters(n) {
      ...
      let t = K.iter(this.view.state.facet(Pr), this.view.viewport.from),
        i = [],
        r = this.gutters.map(
          (s) => new Mm(s, this.view.viewport, -this.view.documentPadding.top),
        )
...
class Mm {
  constructor(e, t, i) {
    ;(this.gutter = e),
      (this.height = i),
      (this.i = 0),
      (this.cursor = K.iter(e.markers, t.from))
  }
  addElement(e, t, i) {
    let { gutter: r } = this,
...
class gh {
  ...
  update(e) {
    let t = this.markers
    if (
      ((this.markers = Oh(this.config.markers(e.view))),
...
const Rm = yn.compute([Ai], (n) => ({
  ...
  lineMarker(e, t, i) {
    return i.some((r) => r.toDOM)
      ? null
      : new Ws(js(e, e.state.doc.lineAt(t.from).number))
  },
  widgetMarker: (e, t, i) => {
  ...
  initialSpacer(e) {
    return new Ws(js(e, mh(e.state.doc.lines)))
  },
  updateSpacer(e, t) {
    let i = js(t.view, mh(t.view.state.doc.lines))
...
class Ll {
  ...
  extend(...e) {
    ...
    for (let i of this.types) {
      ...
      t.push(r ? new Ve(i.name, r, i.id, i.flags) : i)
    }
    return new Ll(t)
  }
}
...
class Se {
  ...
  resolveInner(e, t = 0) {
    let i = En(Sh.get(this) || this.topNode, e, t, !0)
    return Sh.set(this, i), i
  }
  resolveStack(e, t = 0) {
    return Lm(this, e, t)
  }
  ...
  balance(e = {}) {
    return this.children.length <= 8
      ...
      : Vl(
          ...
          e.makeTree || ((t, i, r) => new Se(Ve.none, t, i, r)),
        )
  }
  static build(e) {
    return qm(e)
...
class ti {
  ...
  findChild(e, t, i, r, s) {
    ...
    for (
      let a = e;
      a != t && !(ff(s, r, o[a + 1], o[a + 2]) && ((l = a), i > 0));
      a = o[a + 3]
    );
    return l
  }
    ...
    for (let o = this; ; ) {
      for (
        ...
        if (ff(r, i, c, c + u.length)) {
          ...
          } else if (s & De.IncludeAnonymous || !u.type.isAnonymous || Il(u)) {
            let f
...
class Uo {
  ...
  get node() {
    ...
    for (let r = i; r < this.stack.length; r++)
      t = new Yt(this.buffer, t, this.stack[r])
...
function Il(n) {
  return n.children.some((e) => e instanceof ti || !e.type.isAnonymous || Il(e))
}
function qm(n) {
  var e
  let {
    ...
    l = Array.isArray(t) ? new ql(t, t.length) : t,
    a = i.types,
    h = 0,
    u = 0
  function c(k, y, Q, R, M, j) {
    let { id: Z, start: A, end: x, size: $ } = l,
      z = u,
      I = h
    for (; $ < 0; )
      if ((l.next(), $ == -1)) {
    ...
    if (x - A <= r && (re = g(l.pos - y, M))) {
      ...
      if (
        (oi >= 0 &&
          Ci > 0 &&
          Ci < Ze.length &&
          p(Ze, We, A, Ci, A, Hn, oi, z, I),
        Ze.reverse(),
        We.reverse(),
        oi > -1 && Ci > 0)
      ) {
        let oa = d(L, I)
        ee = Vl(L, Ze, We, 0, Ze.length, 0, x - A, oa, oa)
  ...
  function f(k, y, Q, R) {
    let M = [],
      ...
      Z = -1
    for (; l.pos > y; ) {
      let { id: A, start: x, end: $, size: z } = l
      if (z > 4) l.next()
      else {
        if (Z > -1 && x < Z) break
        Z < 0 && (Z = $ - r), M.push(A, x, $), j++, l.next()
      }
    }
    if (j) {
      let A = new Uint16Array(j * 4),
        x = M[M.length - 2]
      for (let $ = M.length - 3, z = 0; $ >= 0; $ -= 3)
        (A[z++] = M[$]),
          (A[z++] = M[$ + 1] - x),
          (A[z++] = M[$ + 2] - x),
          (A[z++] = z)
      Q.push(new ti(A, M[2] - x, i)), R.push(x - k)
    }
  }
  function d(k, y) {
    return (Q, R, M) => {
      ...
      if (Z >= 0 && (A = Q[Z]) instanceof Se) {
        if (!Z && A.type == k && A.length == M) return A
        ;(x = A.prop(N.lookAhead)) && (j = R[Z] + A.length + x)
      }
      return O(k, Q, R, M, j, y)
    }
  }
  function p(k, y, Q, R, M, j, Z, A, x) {
    let $ = [],
      z = []
    for (; k.length > R; ) $.push(k.pop()), z.push(y.pop() + Q - M)
    k.push(O(i.types[Z], $, z, j - M, A - j, x)), y.push(M - Q)
  }
  function O(k, y, Q, R, M, j, Z) {
    if (j) {
  ...
  function g(k, y) {
    ...
    e: for (let x = Q.pos - k; Q.pos > x; ) {
      let $ = Q.size
      if (Q.id == y && $ >= 0) {
        ;(A.size = R), (A.start = M), (A.skip = j), (j += 4), (R += 4), Q.next()
        continue
      }
      let z = Q.pos - $
      if ($ < 0 || z < x || Q.start < Z) break
      let I = Q.id >= o ? 4 : 0,
        L = Q.start
      for (Q.next(); Q.pos > z; ) {
        if (Q.size < 0)
    ...
    return (
      (y < 0 || R == k) && ((A.size = R), (A.start = M), (A.skip = j)),
      A.size > 4 ? A : void 0
    )
  }
  function S(k, y, Q) {
    let { id: R, start: M, end: j, size: Z } = l
    if ((l.next(), Z >= 0 && R < o)) {
      let A = Q
      if (Z > 4) {
        let x = l.pos - (Z - 4)
  ...
  function d(p, O, g, S, b) {
    for (let D = g; D < S; ) {
      ...
      if (D == v + 1) {
        ...
        c.push(Vl(n, p, O, v, D, k, Q, null, a))
      }
      f.push(k + b - s)
    }
  }
...
class Vr {
  constructor(e) {
    ;(this.name = e), (this.instances = []), (this.id = _m++)
  }
  static get(e, t) {
    if (!t.length) return e
    ...
    let o = Ym(t)
    for (let l of e.set)
      if (!l.modified.length) for (let a of o) r.push(Vr.get(l, a))
    return s
  }
}
function Xm(n, e) {
  ...
  for (let t in n) {
    ...
    for (let r of t.split(' '))
      if (r) {
        ...
        let u = new _r(i, o, a > 0 ? s.slice(0, a) : null)
        e[h] = u.sort(e[h])
      }
  }
  return mf.add(e)
...
class lt {
  ...
  isActiveAt(e, t, i = -1) {
    return Dh(e, t, i).type.prop(Mi) == this.data
  }
  findRegions(e) {
    let t = e.facet(ii)
...
function Dh(n, e, t) {
  ...
  if (!i || i.allowsNesting)
    for (let s = r; s; s = s.enter(e, t, De.ExcludeBuffers))
      s.type.isTop && (r = s)
  return r
}
class Xr extends lt {
...
class Yr {
  ...
  withoutTempSkipped(e) {
    for (let t; (t = this.tempSkipped.pop()); ) e = Ch(e, t.from, t.to)
    return e
  }
  changes(e, t) {
  ...
  updateViewport(e) {
    ...
    for (let i = 0; i < this.skipped.length; i++) {
      ...
      r < e.to &&
        s > e.from &&
        ((this.fragments = Ch(this.fragments, r, s)),
      ...
      createParse(t, i, r) {
        ...
        return {
          ...
          advance() {
            ...
            return (this.parsedPos = o), new Se(Ve.none, [], [], o - s)
          },
          stoppedAt: null,
          stopAt() {},
        }
...
class _i {
  ...
  apply(e) {
    ...
    return t.work(20, i) || t.takeTree(), new _i(t)
  }
  static init(e) {
    let t = Math.min(3e3, e.doc.length),
      i = Yr.create(e.facet(ii).parser, e, { from: 0, to: t })
    return i.work(20, t) || i.takeTree(), new _i(i)
  }
}
lt.state = Ae.define({
  create: _i.init,
      ...
      work(e) {
        ...
        let o =
            ...
            Math.min(
              this.chunkBudget,
              100,
              e && !Vs ? Math.max(25, e.timeRemaining() - 5) : 1e9,
            ),
        ...
        ;(this.chunkBudget -= Date.now() - t),
          (a || this.chunkBudget <= 0) &&
            (s.context.takeTree(),
            this.view.dispatch({ effects: lt.setState.of(new _i(s.context)) })),
...
function _s({ except: n, units: e = 1 } = {}) {
  return (t) => {
  ...
  update(n, e) {
    ...
    for (let t of e.effects)
      if (t.is(Ss) && !g0(n, t.value.from, t.value.to)) {
        let { preparePlaceholder: i } = e.state.facet(Yl),
          r = i ? W.replace({ widget: new D0(i(e.state, t.value)) }) : vh
...
const m0 = (n) => {
    for (let e of wf(n)) {
      ...
      if (t)
        return n.dispatch({ effects: Qf(n.state, [Ss.of(t), Pf(n, t)]) }), !0
    }
    return !1
  },
  S0 = (n) => {
      ...
      class {
        ...
        buildMarkers(o) {
          ...
          for (let a of o.viewportLineBlocks) {
            let h = Ur(o.state, a.from, a.to)
              ? i
              : Gr(o.state, a.from, a.to)
                ? t
                : null
...
function bs(n, e) {
  ...
  return (
    n instanceof Gi &&
      (n.module && t.push(B.styleModule.of(n.module)), (i = n.themeType)),
    e != null && e.fallback
      ? t.push($f.of(n))
      : i
        ? t.push(
            Ko.computeN([B.darkTheme], (r) =>
              r.facet(B.darkTheme) == (i == 'dark') ? [n] : [],
            ),
          )
        : t.push(Ko.of(n)),
    t
...
function z0(n, e, t, i, r, s, o) {
  ...
  for (let f = 0; !u.next().done && f <= s; ) {
    ...
    let p = e + f * t
    for (
      let O = t > 0 ? 0 : d.length - 1, g = t > 0 ? d.length : -1;
      O != g;
      O += t
    ) {
      let S = o.indexOf(d[O])
...
function j0(n, e) {
  ...
  let i = e.replace(/ /g, '_'),
    ...
    s = Ph[r]
  if (s) return s.id
  let o = (Ph[r] = Ve.define({
    id: wh.length,
    name: i,
    props: [gf({ [i]: t })],
  }))
  return wh.push(o), o.id
}
he.RTL, he.LTR
const L0 = (n) => {
  let { state: e } = n,
    ...
    i = Gl(n.state, t.from)
  return i.line ? q0(n) : i.block ? V0(n) : !1
}
function Nl(n, e) {
...
const q0 = Nl(Y0, 0),
  I0 = Nl(zf, 0),
  V0 = Nl((n, e) => zf(n, e, X0(e)), 0)
function Gl(n, e) {
  let t = n.languageDataAt('commentTokens', e)
  return t.length ? t[0] : {}
}
const rn = 50
function _0(n, { open: e, close: t }, i, r) {
...
function zf(n, e, t = e.selection.ranges) {
  ...
  let r = t.map((s, o) => _0(e, i[o], s.from, s.to))
  if (n != 2 && !r.every((s) => s))
    return {
      changes: e.changes(
        t.map((s, o) =>
  ...
  Wf = Ae.define({
    ...
    update(n, e) {
      ...
      if (i) {
        ...
        return (
          a
            ? (u = Hr(u, u.length, t.minDepth, a))
            : (u = If(u, e.startState.selection)),
...
function iS(n, e, t) {
  let i = qf(
    n.selectionsAfter.length ? n.selectionsAfter.map((l) => l.map(e)) : et,
    t,
  )
...
const Mh = (n) => ld(n, !1),
  ...
  Eh = ({ state: n, dispatch: e }) => (e(vt(n, { anchor: 0 })), !0),
  Bh = ({ state: n, dispatch: e }) => (e(vt(n, { anchor: n.doc.length })), !0),
  Rh = ({ state: n, dispatch: e }) => (
    e(vt(n, { anchor: n.selection.main.anchor, head: 0 })), !0
  ),
  ...
  return r.changes.empty
    ...
    : (n.dispatch(
        i.update(r, {
          ...
          effects:
            t == 'delete.selection'
              ? B.announce.of(i.phrase('Selection deleted'))
              : void 0,
        }),
      ),
      !0)
  ...
  return ({ state: e, dispatch: t }) => {
    ...
    let i = e.changeByRange((r) => {
      ...
      return (
        ...
        {
          changes: { from: s, to: o, insert: J.of(c) },
...
const VS = ({ state: n, dispatch: e }) => {
  ...
  YS = [
    ...
    { mac: 'Ctrl-ArrowUp', run: Ah, shift: Mh },
    { key: 'ArrowDown', run: Hf, shift: od, preventDefault: !0 },
    { mac: 'Cmd-ArrowDown', run: Bh, shift: Th },
    { mac: 'Ctrl-ArrowDown', run: nl, shift: $h },
    { key: 'PageUp', run: Ah, shift: Mh },
    { key: 'PageDown', run: nl, shift: $h },
    { key: 'Home', run: uS, shift: kS, preventDefault: !0 },
    { key: 'Mod-Home', run: Eh, shift: Rh },
    { key: 'End', run: hS, shift: xS, preventDefault: !0 },
    { key: 'Mod-End', run: Bh, shift: Th },
    { key: 'Enter', run: Fh, shift: Fh },
    { key: 'Mod-a', run: QS },
  ...
  md = [
    ...
    { key: 'Mod-/', run: L0 },
    { key: 'Alt-A', run: I0 },
    { key: 'Ctrl-m', mac: 'Shift-Alt-m', run: _S },
  ].concat(YS),
...
class yd {
  constructor(e, t, i, r = 0, s = e.length) {
    ...
    ;(this.re = new RegExp(t, Hl + (i != null && i.ignoreCase ? 'i' : ''))),
...
function t1(n, e, t, i) {
  return (
    n(e.sliceDoc(t, t + 1)) == ue.Word && n(e.sliceDoc(i - 1, i)) == ue.Word
  )
}
        ...
        if (r.empty) {
          ...
          if (e.wholeWords) {
            if (
              ...
              !(Wh(o, t, r.from, r.to) && t1(o, t, r.from, r.to)))
            )
              return W.none
...
function s1(n, e) {
  ...
  for (let o = !1, l = new Xi(n.doc, e, i[i.length - 1].to); ; )
    if ((l.next(), l.done)) {
      if (o) return null
      ;(l = new Xi(n.doc, e, 0, Math.max(0, i[i.length - 1].from - 1))),
        (o = !0)
    } else {
...
`
  ...
  getCursor(e, t = 0, i) {
    ...
    return (
      ...
      this.regexp ? Pi(this, r, t, i) : Qi(this, r, t, i)
    )
  }
}
class vd {
...
function h1(n) {
  return (e, t, i) =>
    !i[0].length ||
    ((n(es(i.input, i.index)) != ue.Word ||
      n(ts(i.input, i.index)) != ue.Word) &&
...
class u1 extends vd {
  nextMatch(e, t, i) {
    ...
    return (
      r.done && (r = Pi(this.spec, e, 0, t).next()), r.done ? null : r.value
    )
  }
  prevMatchInRange(e, t, i) {
    for (let r = 1; ; r++) {
    ...
    update(n, e) {
      for (let t of e.effects)
        t.is(Rn)
          ...
          : t.is(Kl) && (n = new Hs(n.query, t.value ? Jl : null))
      return n
    },
...
const is = Gn((n, { query: e }) => {
    ...
    return (
      n.dispatch({
        selection: r,
        effects: [ea(n, i), s.scrollToMatch(r.main, n)],
  ...
  ns = Gn((n, { query: e }) => {
    ...
    return (
      n.dispatch({
        selection: s,
        effects: [ea(n, r), o.scrollToMatch(s.main, n)],
        userEvent: 'select.search',
      }),
      Qd(n),
      !0
  ...
  jh = Gn((n, { query: e }) => {
    ...
    if (
      ...
      let c = l.length == 0 || l[0].from >= s.to ? 0 : s.to - s.from - h.length
      ;(a = w.single(o.from - c, o.to - c)),
        u.push(ea(n, o)),
        u.push(t.facet(Hi).scrollToMatch(a.main, n))
    }
    return (
      n.dispatch({
        changes: l,
...
const Pd = (n) => {
    ...
    if (e && e.panel) {
      ...
      n.dispatch({
        effects: [
          Kl.of(!0),
          e ? Rn.of(ol(n.state, e.query.spec)) : X.appendConfig.of(y1),
        ],
      })
    return !0
  },
...
class S1 {
  ...
  commit() {
    ...
    e.eq(this.query) ||
      ((this.query = e), this.view.dispatch({ effects: Rn.of(e) }))
  }
  keydown(e) {
    Wg(this.view, e, 'search-panel')
      ...
      : e.keyCode == 13 && e.target == this.searchField
        ...
        : e.keyCode == 13 &&
          ...
          (e.preventDefault(), jh(this.view))
  }
  update(e) {
    for (let t of e.transactions)
      for (let i of t.effects)
        i.is(Rn) && !i.value.eq(this.query) && this.setQuery(i.value)
  }
  setQuery(e) {
    ;(this.query = e),
...
function Q1(n, e, t, i, r, s) {
  ...
  if (
    ...
    (u = Math.max(r.top, Math.min(t.top, r.bottom - O)) - e.top),
...
function E1(n, e) {
  let t = [],
    ...
    r = (h) => {
      ...
      if (u) {
        ...
        i.some((f) => f.name == c) ||
          i.push(typeof u == 'string' ? { name: c } : u)
      }
    },
    s = e.facet(Ce)
  for (let h of n)
    if (h.hasResult()) {
      ...
      if (h.result.filter === !1)
        for (let c of h.result.options)
          r(new qh(c, h.source, u ? u(c) : [], 1e9 - t.length))
      else {
        ...
        for (let p of h.result.options)
          if ((f = d.match(p.label))) {
            ...
            r(new qh(p, h.source, O, f.score + (p.boost || 0)))
          }
      }
    }
  if (i) {
  ...
  for (let h of t.sort(
    (u, c) => c.score - u.score || a(u.completion, c.completion),
  )) {
    let u = h.completion
    !l ||
    l.label != u.label ||
...
class ss {
  ...
  update(e) {
    let { state: t } = e,
      i = t.facet(Ce),
      s = (i.override || t.languageDataAt('autocomplete', mi(t)).map(C1)).map(
        (a) =>
          (
    ...
    for (let a of e.effects)
      a.is(Rd) && (o = o && o.setSelected(a.value, this.id))
...
class tt {
  ...
  update(e, t) {
    ...
    for (let s of e.effects)
      ...
      else if (s.is(ta)) for (let o of s.value) o.source == r.source && (r = o)
    return r
  }
  updateFor(e, t) {
...
class zi extends tt {
  ...
  updateFor(e, t) {
    ...
    if (
      l > o ||
      !r ||
      (t & 2 && (mi(e.startState) == this.from || l < this.limit))
    )
...
const W1 = (n) => {
  ...
  Yh = (n) =>
    n.state.field(Le, !1) ? (n.dispatch({ effects: rs.of(!0) }), !0) : !1,
  j1 = (n) => {
    let e = n.state.field(Le, !1)
    ...
    class {
      constructor(n) {
        ;(this.view = n),
          ...
          (this.pendingStart = !1),
          (this.composing = 0)
        for (let e of n.state.field(Le).active)
          e.isPending && this.startQuery(e)
      }
      update(n) {
        let e = n.state.field(Le),
          t = n.state.facet(Ce)
        if (!n.selectionSet && !n.docChanged && n.startState.field(Le) == e)
          return
        ...
        for (let s = 0; s < this.running.length; s++) {
          ...
          if (
            ...
            (o.updates.length + n.transactions.length > q1 &&
              Date.now() - o.time > I1)
          ) {
        ...
        this.debounceUpdate > -1 && clearTimeout(this.debounceUpdate),
          n.transactions.some((s) => s.effects.some((o) => o.is(rs))) &&
            (this.pendingStart = !0)
      ...
      startQuery(n) {
        ...
        this.running.push(r),
          Promise.resolve(n.source(i)).then(
            ...
            (s) => {
              this.view.dispatch({ effects: Tn.of(null) }),
      ...
      accept() {
        ...
        ;(e.length || (i.open && i.open.disabled)) &&
          this.view.dispatch({ effects: ta.of(e) })
      }
    },
    {
      eventHandlers: {
        ...
        compositionend() {
          this.composing == 3 &&
            setTimeout(() => this.view.dispatch({ effects: rs.of(!1) }), 20),
            (this.composing = 0)
        },
      },
    },
  ),
  _1 = typeof navigator == 'object' && /Win/.test(navigator.platform),
  X1 = Di.highest(
    B.domEventHandlers({
      keydown(n, e) {
...
const Td = Ae.define({
  ...
  update(n, e) {
    ...
    for (let t of e.effects)
      t.is(pi) && (n = n.update({ add: [na.range(t.value, t.value + 1)] }))
    return n
  },
})
function Fd() {
...
const Js = '()[]{}<>'
function zd(n) {
  for (let e = 0; e < Js.length; e += 2)
    if (Js.charCodeAt(e) == n) return Js.charAt(e + 1)
...
function K1(n, e) {
  ...
  for (let r of i) {
    ...
    if (e == r)
      return s == r
        ? ib(n, r, i.indexOf(r + r + r) > -1, t)
        : eb(n, r, s, t.before || Fn.before)
...
const jd = [
  ...
  sb = Di.highest(
    _n.computeN([Ce], (n) => (n.facet(Ce).defaultKeymap ? [jd] : [])),
  )
class ob {
  constructor(e, t, i) {
  ...
  Ge = Ae.define({
    ...
    update(n, e) {
      if (e.docChanged && n.diagnostics.size) {
        ...
        !t.size && r && e.state.facet(zn).autoPanel && (r = null),
          (n = new fi(t, r, i))
      }
      for (let t of e.effects)
        if (t.is(Ld)) {
          let i = e.state.facet(zn).autoPanel
            ? t.value.length
              ? Zn.open
              : null
            : n.panel
      ...
      : i.map((s, o) => {
          let l = !1,
            ...
            c =
              u < 0
                ? h
                : [h.slice(0, u), se('u', h.slice(u, u + 1)), h.slice(u + 1)]
          return se(
            'button',
            {
              type: 'button',
...
class Zn {
  constructor(e) {
    ...
    let t = (r) => {
        if (r.keyCode == 27) Uh(this.view), this.view.focus()
  ...
  update() {
    ...
    for (
      e.between(0, this.view.state.doc.length, (o, l, { spec: a }) => {
        ...
        h < 0
          ? ((u = new Hh(this.view, a.diagnostic)),
...
var Kh = function (e) {
  ...
  e.closeBracketsKeymap !== !1 && (i = i.concat(H1)),
    ...
    e.historyKeymap !== !1 && (i = i.concat(Vf)),
  ...
  return (
    ...
    e.allowMultipleSelections !== !1 &&
      r.push(U.allowMultipleSelections.of(!0)),
    ...
    e.tabSize &&
      ...
      r.push(gs.of(' '.repeat(e.tabSize))),
    r.concat([_n.of(i.flat())]).filter(Boolean)
  )
}
const bb = '#e5c07b',
  Jh = '#e06c75',
  ...
  Qb = B.theme(
    {
      '&': { color: Mr, backgroundColor: iu },
      '.cm-content': { caretColor: nu },
      '.cm-cursor, .cm-dropCursor': { borderLeftColor: nu },
      ...
      '.cm-gutters': { backgroundColor: iu, color: ll, border: 'none' },
      '.cm-activeLineGutter': { backgroundColor: tu },
      '.cm-foldPlaceholder': {
      ...
      '.cm-tooltip-autocomplete': {
        '& > ul > li[aria-selected]': { backgroundColor: tu, color: Mr },
      },
    },
    { dark: !0 },
  ),
  Pb = Gi.define([
    ...
    { tag: [m.color, m.constant(m.name), m.standard(m.name)], color: eu },
    ...
    { tag: m.heading, fontWeight: 'bold', color: Jh },
    { tag: [m.atom, m.bool, m.special(m.variableName)], color: eu },
...
var Mb = B.theme({ '&': { backgroundColor: '#fff' } }, { dark: !1 }),
  $b = function (e) {
    ...
    var {
      ...
      a = []
    switch (
      (t && a.unshift(_n.of([NS])),
      l && (typeof l == 'boolean' ? a.unshift(Kh()) : a.unshift(Kh(l))),
      o && a.unshift(hm(o)),
      s)
    ) {
      case 'light':
    ...
    return (
      i === !1 && a.push(B.editable.of(!1)),
      r && a.push(U.readOnly.of(!0)),
      [...a]
    )
  },
  Eb = (n) => ({
...
function Rb(n) {
  var {
    ...
    $ = B.updateListener.of((L) => {
      if (
        L.docChanged &&
        typeof i == 'function' &&
        !L.transactions.some((fe) => fe.annotation(ru))
      ) {
        var ee = L.state.doc,
          re = ee.toString()
        i(re, L)
  ...
  return (
    ...
    H.useEffect(() => {
      M && M.dispatch({ effects: X.reconfigure.of(I) })
    }, [h, l, u, c, f, d, p, O, g, S, b, D, v, i, o]),
    H.useEffect(() => {
      if (e !== void 0) {
        var L = M ? M.state.doc.toString() : ''
        M &&
          e !== L &&
          M.dispatch({
  ...
  _d = H.forwardRef((n, e) => {
    ...
    if (
      (H.useImperativeHandle(
        e,
        () => ({ editor: j.current, state: Z, view: A }),
        [j, x, Z, A],
      ),
      typeof i != 'string')
    )
      throw new Error('value must be typeof string but got ' + typeof i)
    var $ = typeof c == 'string' ? 'cm-theme-' + c : 'cm-theme'
    return C.jsx(
      'div',
      gp({ ref: j, className: '' + $ + (t ? ' ' + t : '') }, M),
    )
  })
_d.displayName = 'CodeMirror'
class os {
...
class al {
  constructor(e, t, i) {
    ;(this.precTable = t),
      (this.elseToken = i),
      (this.data = typeof e == 'string' ? cn(e) : e)
  }
  token(e, t) {
    let i = e.pos,
      r = 0
    for (;;) {
      ...
      if (
        (Xd(this.data, e, t, 0, this.data, this.precTable), e.token.value > -1)
      )
        break
    ...
    if (e) {
      for (
        this.safeFrom = e.openStart
          ? au(e.tree, e.from + e.offset, 1) - e.offset
          : e.from,
          this.safeTo = e.openEnd
            ? au(e.tree, e.to + e.offset, -1) - e.offset
            : e.to;
        this.trees.length;
      ...
      for (let h = o.stateSlot(s, a ? 2 : 1); ; h += 3) {
        if (l[h] == 65535)
          if (l[h + 1] == 1) h = Pt(l, h + 2)
            ...
            r == 0 &&
              l[h + 1] == 2 &&
              (r = this.putAction(Pt(l, h + 2), t, i, r))
            break
          }
...
class Lb {
  ...
  advance() {
    ...
    if (!i.length) {
      ...
      if (o)
        return (
          Ye && console.log('Finish with ' + this.stackID(o)),
          this.stackToTree(o)
        )
    ...
    if (this.recovering && r) {
      ...
      if (o)
        return (
          Ye && console.log('Force-finish ' + this.stackID(o)),
  ...
  advanceStack(e, t, i) {
    ...
    if (this.fragments) {
      ...
      for (let c = this.fragments.nodeAt(r); c; ) {
        ...
        if (!(c instanceof Se) || c.children.length == 0 || c.positions[0] > 0)
          break
        let d = c.children[0]
  ...
  runRecovery(e, t, i) {
    ...
    for (let o = 0; o < e.length; o++) {
      ...
      for (
        ...
        c.forceReduce() &&
        d < 10 &&
        (Ye && console.log(f + this.stackID(c) + ' (via force-reduce)'),
        !this.advanceFully(c, i));
        d++
      )
        Ye && (f = this.stackID(c) + ' -> ')
      for (let d of l.recoverByInsert(a))
        Ye && console.log(u + this.stackID(d) + ' (via recover-insert)'),
    ...
    return (
      ...
      e.specializers &&
        ...
        (t.specializerSpecs = this.specializerSpecs.map((i, r) => {
          ...
          return (t.specializers[r] = uu(o)), o
        }))),
  ...
  dy = new Un(
    (n, e) => {
      ...
      hl.indexOf(t) > -1 ||
        ...
        (t != Yd && t != iy && t != -1 && !e.context && n.acceptToken(_b))
    },
    { contextual: !0 },
  ),
  py = new Un(
    ...
    (n, e) => {
      ...
      if (t == ry || t == sy) {
        if ((n.advance(), t == n.next)) {
          n.advance()
          let i = !e.context && e.canShift(cu)
          n.acceptToken(i ? cu : Yb)
        }
      } else
        t == ay &&
          n.peek(1) == hy &&
          (n.advance(),
          n.advance(),
          (n.next < 48 || n.next > 57) && n.acceptToken(Nb))
    },
    { contextual: !0 },
  )
function no(n, e) {
...
const gy = new Un((n, e) => {
    if (n.next != oy || !e.dialectEnabled(ty) || (n.advance(), n.next == ul))
      return
    let t = 0
  ...
  ky = Xr.define({
    ...
    parser: xy.configure({
      props: [
        yf.add({
          IfStatement: _s({ except: /^\s*({|else\b)/ }),
          TryStatement: _s({ except: /^\s*({|catch\b|finally\b)/ }),
          LabeledStatement: u0,
          SwitchBody: (n) => {
            let e = n.textAfter,
              t = /^\s*\}/.test(e),
...
function dn(n, e, t) {
  ...
  if (i >= 0) {
    ...
    const o = parseInt(r)
    return e === r && i === -1 && !isNaN(o)
      ? ((n[r] = t), n)
      : (n.forEach((l) => dn(l, s, t)), n)
  } else n[r] = t
  return n
}
function hs(n) {
  ...
  var e =
      ...
      (Object.create
        ? function (d, p, O, g) {
            ...
            ;(!S ||
              ('get' in S ? !p.__esModule : S.writable || S.configurable)) &&
              (S = {
                enumerable: !0,
                get: function () {
                  return p[O]
...
function zy(n, e, t) {
  ...
  Array.isArray(i) && i.length
    ...
    : (Array.isArray(i) && i.length === 0 && (0, ro.setPath)(r, t, ''),
      n.push(r))
}
function Zy(n, e) {
  const t = []
...
const Gy = ni,
  ...
  Hy = function (n) {
    const e = new RegExp(n.delimiter.wrap, 'g'),
      t = /\r?\n|\r/,
      i =
        n.parseValue && typeof n.parseValue == 'function' ? n.parseValue : null,
    ...
    function l(x) {
      return x.length === 0
        ? []
        : n.checkSchemaDifferences
          ? a(x)
          : zt.unique(zt.flatten(x))
    }
    function a(x) {
      const $ = x[0],
        z = x.slice(1)
      if (h($, z)) throw new Error(fu.errors.json2csv.notSameSchema)
      return $
    }
    function h(x, $) {
      return $.reduce(
        (z, I) => (zt.computeSchemaDifferences(x, I).length > 0 ? z + 1 : z),
        0,
      )
    }
    function u(x) {
    ...
    function f(x) {
      return (
        n.trimHeaderFields &&
          (x.headerFields = x.headerFields.map(($) =>
            $.split('.')
              .map((z) => z.trim())
              .join('.'),
          )),
    ...
    function d(x) {
      return (
        n.prependHeader &&
          (x.headerFields = x.headerFields.map(function ($) {
            return M($)
          })),
        x
      )
    ...
    function p(x) {
      const $ = Object.keys(n.fieldTitleMap)
      return (
    ...
    function y(x) {
      const $ = x instanceof Date
      return x === null || Array.isArray(x) || (typeof x == 'object' && !$)
        ? JSON.stringify(x)
        : typeof x > 'u'
          ? 'undefined'
          : $ && n.useDateIso8601Format
            ? x.toISOString()
            : n.useLocaleFormat
              ? x.toLocaleString()
              : x.toString()
    ...
    function M(x) {
      const $ = n.delimiter.wrap
      return (
        x.includes(n.delimiter.wrap) && (x = x.replace(e, $ + $)),
    ...
    function Z(x) {
      const $ = x.header,
        z = x.recordString
      return (
        (n.excelBOM ? fu.excelBOM : '') +
        (n.prependHeader ? $ + n.delimiter.eol : '') +
        z
      )
    }
    function A(x) {
...
const tx = ni,
  ...
  nx = function (n) {
    const e = new RegExp(n.delimiter.wrap + n.delimiter.wrap, 'g'),
      ...
      i =
        n.parseValue && typeof n.parseValue == 'function'
          ? n.parseValue
          : JSON.parse
    function r(b) {
      return (
    ...
    function s(b) {
      let D = []
      if (n.headerFields)
        D = n.headerFields.map((v, k) => ({ value: r(v), index: k }))
      else if (
        ((D = b[0].map((k, y) => ({ value: r(k), index: y }))), n.keys)
      ) {
        const k = n.keys
    ...
    function l(b) {
      ...
      for (; A < b.length; ) {
        if (
          ...
          ((Z === n.delimiter.eol && !y.insideWrapDelimiter) || A === v) &&
            M === n.delimiter.field)
        )
          (Z === n.delimiter.eol && y.startIndex === A) ||
          R === n.delimiter.field
            ? Q.push('')
          ...
          (Z === n.delimiter.eol &&
            (!y.insideWrapDelimiter ||
              (y.insideWrapDelimiter &&
                M === n.delimiter.wrap &&
                !y.justParsedDoubleQuote)))
        ) {
          const x = A !== v || M === n.delimiter.wrap ? A : void 0
          ...
          Q.push(b.substring(y.startIndex, A - 1)),
            ...
            (y.parsingValue = !0),
            (y.insideWrapDelimiter = !0),
            (y.justParsedDoubleQuote = !0),
            (A += 1)
        else if (
          (M !== n.delimiter.wrap ||
            (y.justParsedDoubleQuote && M === n.delimiter.wrap)) &&
          R === n.delimiter.wrap &&
          Zt.getNCharacters(b, A + 1, k) === n.delimiter.eol
        )
          ...
          R === n.delimiter.wrap &&
          (A === 0 ||
            (Zt.getNCharacters(b, A - k, k) === n.delimiter.eol &&
              !y.insideWrapDelimiter))
        )
          (y.insideWrapDelimiter = !0),
            (y.parsingValue = !0),
    ...
    function a(b) {
      return (
        n.headerFields
          ? (b.recordLines = b.lines)
          : (b.recordLines = b.lines.splice(1)),
        b
      )
    }
    function h(b, D) {
    ...
    function u(b) {
      const D = g(b)
      return !Zt.isError(D) && !Zt.isInvalid(D)
        ? D
        : b === 'undefined'
          ? void 0
          : b
    ...
    function g(b) {
      try {
        if (Zt.isStringRepresentation(b, n) && !Zt.isDateRepresentation(b))
          return b
        const D = i(b)
...
function ox(n, e) {
  ...
  return (
    (0, Wi.validate)(n, Wi.isObject, Jd.errors.json2csv),
    (0, rx.Json2Csv)(t).convert(n)
  )
}
...
function lx(n, e) {
  ...
  return (
    (0, Wi.validate)(n, Wi.isString, Jd.errors.csv2json),
    (0, sx.Csv2Json)(t).convert(n)
  )
}
Wn.csv2json = lx
var ax = /[\u1680\u2000-\u200A\u202F\u205F\u3000]/,
...
let dl, Te, Mt, us, ri, at, xe, sa, xn
var cx = function (e, t) {
  ;(dl = String(e)),
    (Te = 'start'),
    (Mt = []),
...
`:
  ...
  identifierNameStartEscape() {
    ...
    switch (n) {
      ...
      case '_':
        break
      default:
        if (!de.isIdStartChar(n)) throw du()
        break
    }
    ;(V += n), (Y = 'identifierName')
  },
  identifierName() {
    switch (G) {
      case '$':
  ...
  identifierNameEscape() {
    ...
    switch (n) {
      ...
      case '‍':
        break
      default:
        if (!de.isIdContinueChar(n)) throw du()
        break
    }
    ;(V += n), (Y = 'identifierName')
  },
  ...
  decimalInteger() {
    ...
    return oe('numeric', wt * Number(V))
  },
  decimalPointLeading() {
    if (de.isDigit(G)) {
      ;(V += P()), (Y = 'decimalFraction')
      return
    }
    throw le(P())
  },
  ...
  decimalExponent() {
    switch (G) {
      case '+':
      case '-':
        ;(V += P()), (Y = 'decimalExponentSign')
        return
    }
    if (de.isDigit(G)) {
      ;(V += P()), (Y = 'decimalExponentInteger')
      return
    }
    throw le(P())
  },
...
function px() {
  let n = '',
    e = Bt()
  if (!de.isHexDigit(e) || ((n += P()), (e = Bt()), !de.isHexDigit(e)))
    throw le(P())
...
const Ox = {
  ...
  beforePropertyName() {
    switch (xe.type) {
      case 'identifier':
      case 'string':
        ;(sa = xe.value), (Te = 'afterPropertyName')
        return
      case 'punctuator':
        yr()
        return
...
function lo() {
  ...
  if (n !== null && typeof n == 'object')
    Mt.push(n),
      Array.isArray(n) ? (Te = 'beforeArrayValue') : (Te = 'beforePropertyName')
  else {
    const e = Mt[Mt.length - 1]
    e == null
      ? (Te = 'end')
...
function gx(n) {
  console.warn(
    `JSON5: '${ip(n)}' in strings is not valid ECMAScript; consider escaping`,
  )
}
function ip(n) {
  const e = {
...
` +
  ...
  function d(O) {
    ...
    for (let S = g.length; S < O.length; S++)
      if (!de.isIdContinueChar(String.fromCodePoint(O.codePointAt(S))))
        return c(O)
    return O
  }
  function p(O) {
...
const yx = [
  ...
  Kc(),
  bs(Ef, { fallback: !0 }),
  _n.of([{ key: 'Mod-Enter', run: () => !0 }, md, Vf].flat().filter(Boolean)),
]
function xx(n) {
...
function kx(n) {
  const { color: e, fonts: t } = n.sanity,
    i = e.card.enabled,
    r = ca.blue[e.dark ? 400 : 500].hex,
    s = ca.gray[n.sanity.color.dark ? 900 : 100].hex
  return B.theme(
    {
...
function Dx(n) {
  ...
  return Gi.define([
    ...
    {
      tag: [m.propertyName, m.name, m.deleted, m.character, m.macroName],
      color: t.property,
    },
    { tag: [m.function(m.variableName), m.labelName], color: t.function },
    {
      tag: [m.color, m.constant(m.name), m.standard(m.name)],
      color: t.variable,
    },
...
function sp(n) {
  const e = Ap(),
    t = xx(e)
  return C.jsx(Cx, {
    children: C.jsx(_d, { basicSetup: !1, theme: t, extensions: yx, ...n }),
  })
}
  ...
  return (() => {
    ...
    return (r) => {
      ...
      if (!(typeof s != 'string' || s === ''))
        return (
          s === i || ((i = s), t && URL.revokeObjectURL(t), (t = wx(s, n))), t
        )
    }
  })()
}
...
function zx(n) {
  const { onChange: e } = n,
    { t } = jn(Ln),
    { raw: i, error: r, parsed: s, valid: o } = gu(n.value, t),
    [l, a] = H.useState(o),
    [h, u] = H.useState(!1)
  H.useEffect(() => {
          ...
          children: [
            C.jsxs(Du, {
              ...
              children: [
                C.jsx(It, {
                  weight: 'medium',
                  children: s('settings.perspectives.title'),
                }),
            ...
            C.jsx(ke, {
              children: C.jsx(It, {
                muted: !0,
                children: s('settings.perspectives.description'),
              }),
            }),
            C.jsx(ke, {
              children: C.jsx(It, {
...
function Vx(n) {
  return C.jsxs(At, {
    ...
    marginTop: 2,
    children: [
      C.jsx(gl, { size: 1, children: n.error.message }),
      C.jsx(Lx, { error: n.error }),
    ],
  })
}
const _x = ce.div(({ theme: n }) => {
...
const dk =
  ...
  pk = (n) => ua('ctrl+enter', n) || ua('mod+enter', n)
function Er() {
...
class Ok extends H.PureComponent {
  constructor(t) {
    super(t)
    _e(this, '_visionRoot')
    _e(this, '_queryEditorContainer')
    _e(this, '_paramsEditorContainer')
    _e(this, '_operationUrlElement')
    _e(this, '_customApiVersionElement')
    _e(this, '_resizeListener')
    _e(this, '_querySubscription')
    _e(this, '_listenSubscription')
    _e(this, '_client')
    _e(this, '_localStorage')
  ...
  handleResize(t) {
    ...
    this.setState((r) => ({ ...r, paneSizeOptions: yu(i.contentRect.height) }))
  }
  ...
  handlePaste(t) {
    ...
    const u = kn.includes(l.options.perspective)
  ...
  handleKeyDown(t) {
    ...
    pk(t) &&
      r &&
      i &&
      (this.handleQueryExecution(), t.preventDefault(), t.stopPropagation())
  }
  ensureSelectedApiVersion() {
    const { apiVersion: t, customApiVersion: i } = this.state,
      r = i || t
    this._client.config().apiVersion !== r &&
      this._client.config({ apiVersion: r })
  }
  handleListenExecution() {
    ...
    const o = i instanceof Error ? i : void 0,
      ...
      a = this._client.getDataUrl('listen', Ou(t, l, {})),
      h = !o && t.trim().length > 0
      ...
      h &&
        (this._listenSubscription = this._client
          ...
          .subscribe({
            ...
            error: (u) =>
              this.setState({ error: u, query: t, listenInProgress: !1 }),
          }))
  }
  handleQueryExecution() {
    ...
    const a = this._client.getUrl(this._client.getDataUrl('query', Ou(t, i, l)))
    this.setState({ url: a })
    const h = Date.now()
    return (
      (this._querySubscription = this._client.observable
        ...
        .subscribe({
          ...
          error: (u) =>
            this.setState({ error: u, query: t, queryInProgress: !1 }),
        })),
      !0
    )
  }
                ...
                children: C.jsxs(At, {
                  children: [
                    C.jsx(ke, {
                      ...
                      paddingBottom: 3,
                      children: C.jsx(Qt, {
                        children: i('settings.dataset-label'),
                      }),
                    }),
                    C.jsx(Qs, {
                      value: o,
                ...
                children: C.jsxs(At, {
                  children: [
                    C.jsx(ke, {
                      ...
                      paddingBottom: 3,
                      children: C.jsx(Qt, {
                        children: i('settings.api-version-label'),
                      }),
                    }),
                    C.jsxs(Qs, {
                      value: s === !1 ? r : 'other',
                      ...
                      children: [
                        On.map((M) => C.jsx('option', { children: M }, M)),
                        C.jsx(
                          'option',
                          {
                            value: 'other',
                            children: i('settings.other-api-version-label'),
                          },
                          'other',
                        ),
                      ],
                  ...
                  children: C.jsxs(At, {
                    children: [
                      ...
                      C.jsx(la, {
                        ...
                        customValidity: u
                          ? void 0
                          : i('settings.error.invalid-api-version'),
                        maxLength: 11,
                      }),
                    ],
                  }),
                    ...
                    C.jsx(ke, {
                      ...
                      children: C.jsxs(Du, {
                        ...
                        children: [
                          C.jsx(te, {
                            children: C.jsx(Qt, {
                              children: i('settings.perspective-label'),
                            }),
                          }),
                          ...
                          children: C.jsxs(Qt, {
                            children: [
                              ...
                              C.jsxs(tk, {
                                ...
                                children: [
                                  '[',
                                  i('action.copy-url-to-clipboard'),
                                  ']',
                                ],
                              }),
                            ],
...
class Sk extends H.Component {
  constructor(t) {
    super(t)
    _e(this, 'handleRetryRender', () =>
      this.setState((t) => ({ error: null, numRetries: t.numRetries + 1 })),
    )
    _e(this, 'handleRetryWithCacheClear', () => {
            ...
            C.jsx(ke, {
              ...
              children: C.jsx(At, {
                ...
                children:
                  ...
                  C.jsx(Sl, {
                    size: 1,
                    children: C.jsxs('strong', { children: ['Error: ', t] }),
                  }),
              }),
            }),
          ],
