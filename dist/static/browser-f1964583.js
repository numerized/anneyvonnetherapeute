import { c as Xe, g as qe } from './sanity-033f6ba9.js'
function Ue(G, Q) {
        ...
        Me = function (p, v, S, b) {
          if (x === H)
            if (p === 200 && S != null && Oe.test(S)) {
              ;(x = X), (d = Date.now()), (f = a), (e.readyState = X)
              var m = new te('open', { status: p, statusText: v, headers: b })
              e.dispatchEvent(m), q(e, e.onopen, m)
            } else {
              var g = ''
              p !== 200
                ? (v && (v = v.replace(/\s+/g, ' ')),
              ...
              e.dispatchEvent(m), q(e, e.onerror, m), console.error(g)
            }
        },
        Pe = function (p) {
          if (x === X) {
