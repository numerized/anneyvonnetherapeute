...
} from '@/functions/src/templates/types'
...
export const therapyJourneyEvents: TherapyTimelineEvent[] = [
  ...
  },
  {
    ...
    description:
      'Séance initiale pour comprendre votre situation et vos objectifs',
  },
  {
    type: 'email',
  ...
  },
  {
    ...
    description:
      'Bilan des séances individuelles et préparation pour la réunion du couple',
    triggerType: 'afterSession',
    delayDays: 1,
    partner: 'male',
  },
  ...
  },
  {
    ...
    description:
      "Dernière séance de couple pour intégrer les apprentissages et planifier l'avenir",
  },
  {
    type: 'email',
