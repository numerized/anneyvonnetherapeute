...
export const coupleTherapyJourney: TherapyJourneyEvent[] = [
  ...
  },
  {
    ...
    type: 'session',
    sessionType: 'individual_female_1',
    partner: 'partner2',
    dependsOn: 'initial_session',
    daysOffset: 7,
    phase: 'individual'
  ...
  },
  {
    ...
    type: 'session',
    sessionType: 'individual_female_2',
    partner: 'partner2',
    dependsOn: 'partner2_session_1',
    daysOffset: 14,
    phase: 'individual'
  ...
  },
  {
    ...
    type: 'session',
    sessionType: 'individual_female_3',
    partner: 'partner2',
    dependsOn: 'partner2_session_2',
    daysOffset: 14,
    phase: 'individual'
