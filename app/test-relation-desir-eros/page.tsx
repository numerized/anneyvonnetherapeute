...
const optionsMap = {
  rapport_desir: [
    {
      id: 'A',
      label: "Il est fluide et naturel, je l'accueille pleinement.",
      points: 4,
    },
    ...
    {
      id: 'D',
      label: "J'ai du mal à le percevoir ou à le laisser s'exprimer.",
      points: 1,
    },
  ],
  aisance_corporelle: [
    {
      id: 'A',
      label: "Avec aisance, j'apprécie explorer et ressentir.",
      points: 4,
    },
    {
      id: 'B',
      label: 'Avec quelques freins, mais je cherche à les comprendre.',
      points: 3,
    },
    {
      id: 'C',
      label: "Avec retenue, j'ai du mal à me lâcher complètement.",
      points: 2,
    },
    {
      id: 'D',
      label: "Avec gêne, j'ai souvent envie d'éviter ces moments.",
      points: 1,
    },
  ],
  limites_blocages: [
    {
      id: 'A',
      label: 'Exprimer clairement mes ressentis et besoins.',
      points: 4,
    },
    {
      id: 'B',
      label: 'Hésiter, mais réussir à en parler après réflexion.',
      points: 3,
    },
    {
      id: 'C',
      label: "Me taire pour éviter de blesser ou perturber l'autre.",
      points: 2,
    },
  ...
  rapport_plaisir: [
    ...
    {
      id: 'B',
      label: 'Une place importante mais parfois mise de côté.',
      points: 3,
    },
    {
      id: 'C',
      label: 'Une place secondaire, le quotidien prend le dessus.',
      points: 2,
    },
    {
      id: 'D',
      label: "Une place floue, je ne sais pas comment m'y reconnecter.",
      points: 1,
    },
  ],
  desirs_decouvertes: [
    {
      id: 'A',
      label: "Curieux(se) et enthousiaste, j'aime explorer.",
      points: 4,
    },
    {
      id: 'B',
      label: 'Prudent(e), mais ouvert(e) à ce qui me correspond.',
      points: 3,
    },
    {
      id: 'C',
      label: 'Réservé(e), avec une préférence pour ce qui est connu.',
      points: 2,
    },
    {
      id: 'D',
      label: "Fermé(e) à toute idée de changement ou d'exploration.",
      points: 1,
    },
  ],
}
...
const results: Result[] = [
  {
    ...
    emoji: '🔸',
    description:
      "Vous êtes en harmonie avec votre désir et votre sensualité. Vous savez exprimer vos besoins et accueillir l'intimité comme un espace d'exploration et de partage. Vous cherchez à équilibrer plaisir et émotion avec aisance.",
  },
  {
    range: [13, 16],
    ...
    emoji: '🔹',
    description:
      'Vous avez une bonne connexion à votre désir, mais certaines hésitations ou conditionnements peuvent encore freiner votre épanouissement. Vous êtes en chemin vers une sexualité plus alignée et consciente.',
  },
  {
    range: [9, 12],
    ...
    emoji: '🟠',
    description:
      "Vous ressentez parfois un décalage entre vos désirs profonds et leur expression. Peut-être avez-vous tendance à réprimer certains élans ou à prioriser d'autres aspects de votre vie. Une réflexion plus poussée pourrait vous aider à vous reconnecter à votre plaisir.",
  },
  {
    range: [5, 8],
    ...
    emoji: '🔻',
    description:
      "Votre rapport au désir semble bridé par des peurs, des blocages ou un manque de connexion à votre propre corps et à vos envies. Explorer votre relation à l'intimité avec douceur et curiosité pourrait vous permettre de renouer avec votre sensualité.",
  },
  {
    range: [0, 4],
    ...
    emoji: '⚫',
    description:
      "Votre sexualité est actuellement en veille, soit par choix, soit par circonstances. Peut-être ressentez-vous de l'indifférence, du rejet ou de l'appréhension face au désir. Une introspection plus profonde et un accompagnement bienveillant pourraient vous aider à comprendre ce positionnement.",
  },
]
    ...
    questions.forEach((question) => {
      ...
      if (answer) {
        const questionOptions =
          optionsMap[question.id as keyof typeof optionsMap]
        ...
        <div className="max-w-2xl mx-auto space-y-8">
          <div className="text-center">
            ...
            <p className="text-sm sm:text-base text-primary-cream/80 mb-2">
              Ce test vous aide à mieux comprendre votre relation au désir et à
              l'intimité, pour un épanouissement plus conscient et authentique.
            </p>
          </div>
          ...
          <div className="bg-primary-cream/10 rounded-lg p-6">
            <div className="text-center space-y-4">
              ...
              <p className="text-2xl font-bold text-primary-coral">COEUR180</p>
              <div className="flex justify-center gap-4 mt-4">
                <Link
                  href="/prochainement?coupon=COEUR180"
                  className="px-6 py-2 bg-primary-coral text-primary-cream rounded-full hover:bg-primary-rust transition-colors"
                >
                  Découvrir l'offre
                </Link>
                <button
    ...
    <div className="bg-primary-forest text-primary-cream p-8">
      <div className="max-w-2xl mx-auto space-y-8">
        <div className="text-center">
          ...
          <p className="text-sm sm:text-base text-primary-cream/80 mb-2">
            Ce test est conçu pour explorer vos facilités, difficultés, désirs
            et rejets en matière de sexualité et d'intimité, en toute
            introspection et sans jugement.
          </p>
        ...
        <div className="bg-primary-cream/10 rounded-lg p-6">
          <div className="mb-6">
            ...
            <RadioGroup
              ...
              className="space-y-3"
            >
              {optionsMap[currentQuestion.id as keyof typeof optionsMap].map(
                (option) => (
                  <RadioGroup.Option
                    key={option.id}
                    value={option.id}
                    className={({ active, checked }) =>
                      `${
                        active
                          ? 'ring-2 ring-primary-coral ring-opacity-60 ring-offset-2 ring-offset-primary-forest'
                          : ''
                      }
                    ${
                      checked
                        ? 'bg-primary-coral/20 border-primary-coral text-primary-coral'
                        : 'bg-primary-cream/5 border-primary-cream/20 text-primary-cream'
                    }
