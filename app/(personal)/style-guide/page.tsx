    ...
    <div className="min-h-screen bg-primary-dark p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <section className="mb-16">
          <h2 className="text-3xl text-primary-cream font-light mb-8">
            Typography
          </h2>

          <div className="space-y-8 bg-primary-forest/30 p-8 rounded-[24px]">
            <div>
              <h1 className="text-6xl text-primary-cream">
                Heading 1 (text-6xl)
              </h1>
              <h2 className="text-5xl text-primary-cream font-light">
                Heading 2 (text-5xl)
              </h2>
              <h3 className="text-4xl text-primary-cream font-light">
                Heading 3 (text-4xl)
              </h3>
              <h4 className="text-3xl text-primary-cream font-light">
                Heading 4 (text-3xl)
              </h4>
              <h5 className="text-2xl text-primary-cream font-light">
                Heading 5 (text-2xl)
              </h5>
              <h6 className="text-xl text-primary-cream font-light">
                Heading 6 (text-xl)
              </h6>
            </div>
            ...
            <div className="space-y-4">
              <p className="text-primary-cream/90 text-lg">
                Large paragraph text (text-lg) - Lorem ipsum dolor sit amet,
                consectetur adipiscing elit.
              </p>
              <p className="text-primary-cream/80">
                Regular paragraph text (base) - Lorem ipsum dolor sit amet,
                consectetur adipiscing elit.
              </p>
            ...
            <div className="space-y-2">
              <p className="font-light text-primary-cream">
                Font Weight Light (300)
              </p>
              <p className="font-normal text-primary-cream">
                Font Weight Normal (400)
              </p>
              <p className="font-medium text-primary-cream">
                Font Weight Medium (500)
              </p>
              <p className="font-semibold text-primary-cream">
                Font Weight Semibold (600)
              </p>
              <p className="font-bold text-primary-cream">
        ...
        <section className="mb-16">
          ...
          <div className="space-y-12 bg-primary-forest/30 p-8 rounded-[24px]">
            ...
            <div className="space-y-6">
              <h3 className="text-2xl text-primary-cream font-light mb-4">
                Buttons
              </h3>
              <div className="space-y-4">
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-primary-dark/30 backdrop-blur-sm rounded-[24px] p-6">
                  <h4 className="text-xl text-primary-cream font-light mb-4">
                    Card Title
                  </h4>
                  <p className="text-primary-cream/80">
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="bg-primary-forest/30 p-4 rounded-[16px] text-primary-cream text-center">
                  1
                </div>
                <div className="bg-primary-forest/30 p-4 rounded-[16px] text-primary-cream text-center">
                  2
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="bg-primary-forest/30 p-2 rounded-[16px] text-primary-cream text-center">
                  p-2
                </div>
                <div className="bg-primary-forest/30 p-4 rounded-[16px] text-primary-cream text-center">
                  p-4
                </div>
                <div className="bg-primary-forest/30 p-6 rounded-[16px] text-primary-cream text-center">
                  p-6
                </div>
                <div className="bg-primary-forest/30 p-8 rounded-[16px] text-primary-cream text-center">
                  p-8
                </div>
              </div>
            </div>
