...
async function getSettings() {
  try {
    ...
    if (!settings && process.env.NODE_ENV === 'development') {
      console.warn(
        'No settings document found in Sanity. Please create one in your Sanity Studio.',
      )
    }
  ...
  try {
    ...
    const pageData = {
      hero: {
        title: 'Webinar',
        subtitle:
          'Découvrez notre webinar exclusif sur les relations conscientes',
      },
    }
        ...
        <div className="min-h-screen bg-primary-forest p-8">
          ...
          <div className="mt-4 p-4 bg-yellow-500/20 rounded-lg">
            ...
            <ol className="text-white list-decimal list-inside space-y-2">
              <li>
                Verify that a settings document exists in your Sanity Studio
              </li>
    ...
    return (
      <div className="min-h-screen bg-primary-forest flex items-center justify-center">
        <div className="text-center text-white p-8">
          ...
          <p>
            Nous travaillons à résoudre le problème. Merci de réessayer plus
            tard.
          </p>
        </div>
      </div>
