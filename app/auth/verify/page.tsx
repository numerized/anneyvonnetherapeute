      ...
      try {
        ...
        if (invitationToken && invitationId && inviterId) {
          ...
          try {
            ...
            const connectPartnersFunction = httpsCallable(
              functions,
              'connectPartners',
            )
            ...
            toast.error(
              error.message ||
                'Erreur lors de la connexion des comptes partenaires',
            )
          }
        }
      ...
      <div className="w-full max-w-md px-4 space-y-8">
        <div className="text-center">
          ...
          {isVerifying ? (
            ...
            <>
              <p className="mt-2 text-primary-cream/80">
                Nous n'avons pas trouvé votre email. Veuillez le saisir à
                nouveau ci-dessous.
              </p>
              <form
            ...
            <div className="space-y-6">
              <p className="mt-2 text-primary-cream/80">
                Ce lien n'est plus valide. Veuillez demander un nouveau lien de
                connexion.
              </p>
              <Button
